...
public:
	...
	static class AAbility_VH_Hover_WL04_StickyBomb_C* GetDefaultObj();

	void ReceiveBeginPlay();
	void ReceiveTick(float DeltaSeconds);
	void ExecuteUbergraph_Ability_VH_Hover_WL04_StickyBomb(int32 EntryPoint, float K2Node_Event_DeltaSeconds);
};
