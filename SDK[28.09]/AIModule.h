...
{ 
public:
	unsigned char                                      UnknownData00_2[0x38];                                      // 0x02B8   (0x0038)  MISSED
	bool                                               bStartAILogicOnPossess;                                     // 0x02F0:0 (0x0001)  
	bool                                               bStopAILogicOnUnposses;                                     // 0x02F0:1 (0x0001)  
	bool                                               bLOSflag;                                                   // 0x02F0:2 (0x0001)  
	bool                                               bSkipExtraLOSChecks;                                        // 0x02F0:3 (0x0001)  
	bool                                               bAllowStrafe;                                               // 0x02F0:4 (0x0001)  
	bool                                               bWantsPlayerState;                                          // 0x02F0:5 (0x0001)  
	bool                                               bSetControlRotationFromPawnOrientation;                     // 0x02F0:6 (0x0001)  
	unsigned char                                      UnknownData01_4[0x7];                                       // 0x02F1   (0x0007)  MISSED
	UPathFollowingComponent*                           PathFollowingComponent;                                     // 0x02F8   (0x0008)  
	UBrainComponent*                                   BrainComponent;                                             // 0x0300   (0x0008)  
	UAIPerceptionComponent*                            PerceptionComponent;                                        // 0x0308   (0x0008)  
	UPawnActionsComponent*                             ActionsComp;                                                // 0x0310   (0x0008)  
	UBlackboardComponent*                              Blackboard;                                                 // 0x0318   (0x0008)  
	UGameplayTasksComponent*                           CachedGameplayTasksComponent;                               // 0x0320   (0x0008)  
	UClass*                                            DefaultNavigationFilterClass;                               // 0x0328   (0x0008)  
	FMulticastInlineDelegate                           ReceiveMoveCompleted;                                       // 0x0330   (0x0010)  
	unsigned char                                      UnknownData02_6[0x8];                                       // 0x0340   (0x0008)  MISSED


	/// Functions
	// Function /Script/AIModule.AIController.UseBlackboard
	bool UseBlackboard(UBlackboardData* BlackboardAsset, UBlackboardComponent*& BlackboardComponent);                        // [0x413c4b0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AIModule.AIController.UnclaimTaskResource
	void UnclaimTaskResource(UClass* ResourceClass);                                                                         // [0x413c260] Final|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.AIController.SetPathFollowingComponent
	void SetPathFollowingComponent(UPathFollowingComponent* NewPFComponent);                                                 // [0x413bd50] Final|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.AIController.SetMoveBlockDetection
	void SetMoveBlockDetection(bool bEnable);                                                                                // [0x413bcc0] Final|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.AIController.RunBehaviorTree
	bool RunBehaviorTree(UBehaviorTree* BTAsset);                                                                            // [0x413bad0] Native|Public|BlueprintCallable 
	// Function /Script/AIModule.AIController.OnUsingBlackBoard
	void OnUsingBlackBoard(UBlackboardComponent* BlackboardComp, UBlackboardData* BlackboardAsset);                          // [0x2649560] Event|Protected|BlueprintEvent 
	// Function /Script/AIModule.AIController.OnGameplayTaskResourcesClaimed
	void OnGameplayTaskResourcesClaimed(FGameplayResourceSet NewlyClaimed, FGameplayResourceSet FreshlyReleased);            // [0x413b470] Native|Public        
	// Function /Script/AIModule.AIController.MoveToLocation
	TEnumAsByte<EPathFollowingRequestResult> MoveToLocation(FVector& Dest, float AcceptanceRadius, bool bStopOnOverlap, bool bUsePathfinding, bool bProjectDestinationToNavigation, bool bCanStrafe, UClass* FilterClass, bool bAllowPartialPath); // [0x413b1e0] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/AIModule.AIController.MoveToActor
	TEnumAsByte<EPathFollowingRequestResult> MoveToActor(AActor* Goal, float AcceptanceRadius, bool bStopOnOverlap, bool bUsePathfinding, bool bCanStrafe, UClass* FilterClass, bool bAllowPartialPath); // [0x413afa0] Final|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.AIController.K2_SetFocus
	void K2_SetFocus(AActor* NewFocus);                                                                                      // [0x413ae00] Final|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.AIController.K2_SetFocalPoint
	void K2_SetFocalPoint(FVector FP);                                                                                       // [0x413ad70] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/AIModule.AIController.K2_ClearFocus
	void K2_ClearFocus();                                                                                                    // [0x413ad50] Final|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.AIController.HasPartialPath
	bool HasPartialPath();                                                                                                   // [0x413ab70] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.AIController.GetPathFollowingComponent
	UPathFollowingComponent* GetPathFollowingComponent();                                                                    // [0x413a870] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.AIController.GetMoveStatus
	TEnumAsByte<EPathFollowingStatus> GetMoveStatus();                                                                       // [0x413a840] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.AIController.GetImmediateMoveDestination
	FVector GetImmediateMoveDestination();                                                                                   // [0x413a710] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.AIController.GetFocusActor
	AActor* GetFocusActor();                                                                                                 // [0x413a6e0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.AIController.GetFocalPointOnActor
	FVector GetFocalPointOnActor(AActor* Actor);                                                                             // [0x413a630] Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.AIController.GetFocalPoint
	FVector GetFocalPoint();                                                                                                 // [0x413a5f0] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.AIController.GetAIPerceptionComponent
	UAIPerceptionComponent* GetAIPerceptionComponent();                                                                      // [0x413a2c0] Final|Native|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/AIModule.AIController.ClaimTaskResource
	void ClaimTaskResource(UClass* ResourceClass);                                                                           // [0x4139fa0] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	void ReceiveTickAI(AAIController* OwnerController, APawn* ControlledPawn, float DeltaSeconds);                           // [0x2649560] Event|Protected|BlueprintEvent 
	// Function /Script/AIModule.BTService_BlueprintBase.ReceiveTick
	void ReceiveTick(AActor* OwnerActor, float DeltaSeconds);                                                                // [0x2649560] Event|Protected|BlueprintEvent 
	// Function /Script/AIModule.BTService_BlueprintBase.ReceiveSearchStartAI
	void ReceiveSearchStartAI(AAIController* OwnerController, APawn* ControlledPawn);                                        // [0x2649560] Event|Protected|BlueprintEvent 
	// Function /Script/AIModule.BTService_BlueprintBase.ReceiveSearchStart
	void ReceiveSearchStart(AActor* OwnerActor);                                                                             // [0x2649560] Event|Protected|BlueprintEvent 
	// Function /Script/AIModule.BTService_BlueprintBase.ReceiveDeactivationAI
	void ReceiveDeactivationAI(AAIController* OwnerController, APawn* ControlledPawn);                                       // [0x2649560] Event|Protected|BlueprintEvent 
	// Function /Script/AIModule.BTService_BlueprintBase.ReceiveDeactivation
	void ReceiveDeactivation(AActor* OwnerActor);                                                                            // [0x2649560] Event|Protected|BlueprintEvent 
	// Function /Script/AIModule.BTService_BlueprintBase.ReceiveActivationAI
	void ReceiveActivationAI(AAIController* OwnerController, APawn* ControlledPawn);                                         // [0x2649560] Event|Protected|BlueprintEvent 
	// Function /Script/AIModule.BTService_BlueprintBase.ReceiveActivation
	void ReceiveActivation(AActor* OwnerActor);                                                                              // [0x2649560] Event|Protected|BlueprintEvent 
	// Function /Script/AIModule.BTService_BlueprintBase.IsServiceActive
	bool IsServiceActive();                                                                                                  // [0x4148d80] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	ANavigationData*                                   MyNavData;                                                  // 0x0100   (0x0008)  
	unsigned char                                      UnknownData02_6[0x158];                                     // 0x0108   (0x0158)  MISSED


	/// Functions
	// Function /Script/AIModule.PathFollowingComponent.OnNavDataRegistered
	void OnNavDataRegistered(ANavigationData* NavData);                                                                      // [0x41540c0] Final|Native|Protected 
	// Function /Script/AIModule.PathFollowingComponent.OnActorBump
	void OnActorBump(AActor* SelfActor, AActor* OtherActor, FVector NormalImpulse, FHitResult& Hit);                         // [0x4153f20] Native|Public|HasOutParms|HasDefaults 
	// Function /Script/AIModule.PathFollowingComponent.GetPathDestination
	FVector GetPathDestination();                                                                                            // [0x4153af0] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.PathFollowingComponent.GetPathActionType
	TEnumAsByte<EPathFollowingAction> GetPathActionType();                                                                   // [0x4153ac0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	UCharacterMovementComponent*                       CharacterMovement;                                          // 0x0268   (0x0008)  
	...
	void SuspendCrowdSteering(bool bSuspend);                                                                                // [0x414d0a0] Native|Public|BlueprintCallable 
};
...
public:
	...
	TArray<FNavigationLink>                            PointLinks;                                                 // 0x0238   (0x0010)  
	TArray<FNavigationSegmentLink>                     SegmentLinks;                                               // 0x0248   (0x0010)  
	UNavLinkCustomComponent*                           SmartLinkComp;                                              // 0x0258   (0x0008)  
	bool                                               bSmartLinkIsRelevant;                                       // 0x0260   (0x0001)  
	unsigned char                                      UnknownData01_5[0x7];                                       // 0x0261   (0x0007)  MISSED
	FMulticastInlineDelegate                           OnSmartLinkReached;                                         // 0x0268   (0x0010)  


	/// Functions
	// Function /Script/AIModule.NavLinkProxy.SetSmartLinkEnabled
	void SetSmartLinkEnabled(bool bEnabled);                                                                                 // [0x4154560] Final|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.NavLinkProxy.ResumePathFollowing
	void ResumePathFollowing(AActor* Agent);                                                                                 // [0x4154250] Final|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.NavLinkProxy.ReceiveSmartLinkReached
	void ReceiveSmartLinkReached(AActor* Agent, FVector& Destination);                                                       // [0x2649560] Event|Public|HasOutParms|HasDefaults|BlueprintEvent 
	// Function /Script/AIModule.NavLinkProxy.IsSmartLinkEnabled
	bool IsSmartLinkEnabled();                                                                                               // [0x4153ba0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.NavLinkProxy.HasMovingAgents
	bool HasMovingAgents();                                                                                                  // [0x4153b70] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	void SetSenseEnabled(UClass* SenseClass, bool bEnable);                                                                  // [0x413bde0] Final|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.AIPerceptionComponent.RequestStimuliListenerUpdate
	void RequestStimuliListenerUpdate();                                                                                     // [0x413bab0] Final|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.AIPerceptionComponent.OnOwnerEndPlay
	void OnOwnerEndPlay(AActor* Actor, TEnumAsByte<EEndPlayReason> EndPlayReason);                                           // [0x413b610] Final|Native|Public  
	// Function /Script/AIModule.AIPerceptionComponent.GetPerceivedHostileActors
	void GetPerceivedHostileActors(TArray<AActor*>& OutActors);                                                              // [0x413a980] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.AIPerceptionComponent.GetPerceivedActors
	void GetPerceivedActors(UClass* SenseToUse, TArray<AActor*>& OutActors);                                                 // [0x413a890] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.AIPerceptionComponent.GetKnownPerceivedActors
	void GetKnownPerceivedActors(UClass* SenseToUse, TArray<AActor*>& OutActors);                                            // [0x413a750] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.AIPerceptionComponent.GetCurrentlyPerceivedActors
	void GetCurrentlyPerceivedActors(UClass* SenseToUse, TArray<AActor*>& OutActors);                                        // [0x413a500] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.AIPerceptionComponent.GetActorsPerception
	bool GetActorsPerception(AActor* Actor, FActorPerceptionBlueprintInfo& Info);                                            // [0x413a2e0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AIModule.AIPerceptionComponent.ForgetAll
	void ForgetAll();                                                                                                        // [0x413a210] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	void OnMoveCompleted(FAIRequestID RequestID, TEnumAsByte<EPathFollowingResult> MovementResult);                          // [0x413b540] Final|Native|Public  
};
...
public:
	...
	void UnregisterFromSense(UClass* SenseClass);                                                                            // [0x413c420] Final|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.AIPerceptionStimuliSourceComponent.UnregisterFromPerceptionSystem
	void UnregisterFromPerceptionSystem();                                                                                   // [0x413c400] Final|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.AIPerceptionStimuliSourceComponent.RegisterWithPerceptionSystem
	void RegisterWithPerceptionSystem();                                                                                     // [0x413b940] Final|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.AIPerceptionStimuliSourceComponent.RegisterForSense
	void RegisterForSense(UClass* SenseClass);                                                                               // [0x413b7b0] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	UAISystem*                                         AISystem;                                                   // 0x0038   (0x0008)  
};
...
public:
	...
	TArray<UAISense*>                                  Senses;                                                     // 0x0090   (0x0010)  
	float                                              PerceptionAgingRate;                                        // 0x00A0   (0x0004)  
	unsigned char                                      UnknownData01_6[0x9C];                                      // 0x00A4   (0x009C)  MISSED


	/// Functions
	// Function /Script/AIModule.AIPerceptionSystem.ReportPerceptionEvent
	void ReportPerceptionEvent(UObject* WorldContextObject, UAISenseEvent* PerceptionEvent);                                 // [0x413b9f0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/AIModule.AIPerceptionSystem.ReportEvent
	void ReportEvent(UAISenseEvent* PerceptionEvent);                                                                        // [0x413b960] Final|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.AIPerceptionSystem.RegisterPerceptionStimuliSource
	bool RegisterPerceptionStimuliSource(UObject* WorldContextObject, UClass* Sense, AActor* Target);                        // [0x413b840] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/AIModule.AIPerceptionSystem.OnPerceptionStimuliSourceEndPlay
	void OnPerceptionStimuliSourceEndPlay(AActor* Actor, TEnumAsByte<EEndPlayReason> EndPlayReason);                         // [0x413b6e0] Final|Native|Protected 
	// Function /Script/AIModule.AIPerceptionSystem.GetSenseClassForStimulus
	UClass* GetSenseClassForStimulus(UObject* WorldContextObject, FAIStimulus& Stimulus);                                    // [0x413aa30] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	float OnUpdate(TArray<UAISenseEvent*>& EventsToProcess);                                                                 // [0x2649560] Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/AIModule.AISense_Blueprint.OnListenerUpdated
	void OnListenerUpdated(AActor* ActorListener, UAIPerceptionComponent* PerceptionComponent);                              // [0x2649560] Event|Public|BlueprintEvent 
	// Function /Script/AIModule.AISense_Blueprint.OnListenerUnregistered
	void OnListenerUnregistered(AActor* ActorListener, UAIPerceptionComponent* PerceptionComponent);                         // [0x2649560] Event|Public|BlueprintEvent 
	// Function /Script/AIModule.AISense_Blueprint.OnListenerRegistered
	void OnListenerRegistered(AActor* ActorListener, UAIPerceptionComponent* PerceptionComponent);                           // [0x2649560] Event|Public|BlueprintEvent 
	// Function /Script/AIModule.AISense_Blueprint.K2_OnNewPawn
	void K2_OnNewPawn(APawn* NewPawn);                                                                                       // [0x2649560] Event|Public|BlueprintEvent 
	// Function /Script/AIModule.AISense_Blueprint.GetAllListenerComponents
	void GetAllListenerComponents(TArray<UAIPerceptionComponent*>& ListenerComponents);                                      // [0x4140390] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.AISense_Blueprint.GetAllListenerActors
	void GetAllListenerActors(TArray<AActor*>& ListenerActors);                                                              // [0x41402e0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	void ReportDamageEvent(UObject* WorldContextObject, AActor* DamagedActor, AActor* Instigator, float DamageAmount, FVector EventLocation, FVector HitLocation); // [0x41404e0] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
};
...
public:
	...
	void ReportNoiseEvent(UObject* WorldContextObject, FVector NoiseLocation, float Loudness, AActor* Instigator, float MaxRange, FName Tag); // [0x41406d0] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
};
...
public:
	...
	void RequestPawnPredictionEvent(APawn* Requestor, AActor* PredictedActor, float PredictionTime);                         // [0x41409c0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/AIModule.AISense_Prediction.RequestControllerPredictionEvent
	void RequestControllerPredictionEvent(AAIController* Requestor, AActor* PredictedActor, float PredictionTime);           // [0x41408b0] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	TEnumAsByte<ECollisionChannel>                     DefaultSightCollisionChannel;                               // 0x009B   (0x0001)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x009C   (0x0004)  MISSED
	...
	void AILoggingVerbose();                                                                                                 // [0x30f3ba0] Exec|Native|Public   
	// Function /Script/AIModule.AISystem.AIIgnorePlayers
	void AIIgnorePlayers();                                                                                                  // [0x220b940] Exec|Native|Public   
};
...
public:
	...
	void StopLogic(FString reason);                                                                                          // [0x4145520] Native|Public|BlueprintCallable 
	// Function /Script/AIModule.BrainComponent.StartLogic
	void StartLogic();                                                                                                       // [0xc455a0] Native|Public|BlueprintCallable 
	// Function /Script/AIModule.BrainComponent.RestartLogic
	void RestartLogic();                                                                                                     // [0xc45580] Native|Public|BlueprintCallable 
	// Function /Script/AIModule.BrainComponent.IsRunning
	bool IsRunning();                                                                                                        // [0x4144b50] Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.BrainComponent.IsPaused
	bool IsPaused();                                                                                                         // [0x4144b20] Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	TArray<UBTNode*>                                   NodeInstances;                                              // 0x0130   (0x0010)  
	unsigned char                                      UnknownData01_5[0x128];                                     // 0x0140   (0x0128)  MISSED
	UBehaviorTree*                                     DefaultBehaviorTreeAsset;                                   // 0x0268   (0x0008)  


	/// Functions
	// Function /Script/AIModule.BehaviorTreeComponent.SetDynamicSubtree
	void SetDynamicSubtree(FGameplayTag InjectTag, UBehaviorTree* BehaviorAsset);                                            // [0x4140ba0] Native|Public|BlueprintCallable 
	// Function /Script/AIModule.BehaviorTreeComponent.GetTagCooldownEndTime
	float GetTagCooldownEndTime(FGameplayTag CooldownTag);                                                                   // [0x4140440] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.BehaviorTreeComponent.AddCooldownTagDuration
	void AddCooldownTagDuration(FGameplayTag CooldownTag, float CoolDownDuration, bool bAddToExistingDuration);              // [0x41401c0] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	void SetValueAsVector(FName& KeyName, FVector VectorValue);                                                              // [0x4145430] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/AIModule.BlackboardComponent.SetValueAsString
	void SetValueAsString(FName& KeyName, FString StringValue);                                                              // [0x41452f0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AIModule.BlackboardComponent.SetValueAsRotator
	void SetValueAsRotator(FName& KeyName, FRotator VectorValue);                                                            // [0x4145200] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/AIModule.BlackboardComponent.SetValueAsObject
	void SetValueAsObject(FName& KeyName, UObject* ObjectValue);                                                             // [0x4145130] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AIModule.BlackboardComponent.SetValueAsName
	void SetValueAsName(FName& KeyName, FName NameValue);                                                                    // [0x4145060] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AIModule.BlackboardComponent.SetValueAsInt
	void SetValueAsInt(FName& KeyName, int32_t IntValue);                                                                    // [0x4144f90] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AIModule.BlackboardComponent.SetValueAsFloat
	void SetValueAsFloat(FName& KeyName, float FloatValue);                                                                  // [0x4144eb0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AIModule.BlackboardComponent.SetValueAsEnum
	void SetValueAsEnum(FName& KeyName, char EnumValue);                                                                     // [0x4144dd0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AIModule.BlackboardComponent.SetValueAsClass
	void SetValueAsClass(FName& KeyName, UClass* ClassValue);                                                                // [0x4144d00] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AIModule.BlackboardComponent.SetValueAsBool
	void SetValueAsBool(FName& KeyName, bool BoolValue);                                                                     // [0x4144c20] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AIModule.BlackboardComponent.IsVectorValueSet
	bool IsVectorValueSet(FName& KeyName);                                                                                   // [0x4144b80] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.BlackboardComponent.GetValueAsVector
	FVector GetValueAsVector(FName& KeyName);                                                                                // [0x4144a10] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.BlackboardComponent.GetValueAsString
	FString GetValueAsString(FName& KeyName);                                                                                // [0x4144930] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.BlackboardComponent.GetValueAsRotator
	FRotator GetValueAsRotator(FName& KeyName);                                                                              // [0x4144880] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.BlackboardComponent.GetValueAsObject
	UObject* GetValueAsObject(FName& KeyName);                                                                               // [0x41447e0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.BlackboardComponent.GetValueAsName
	FName GetValueAsName(FName& KeyName);                                                                                    // [0x4144740] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.BlackboardComponent.GetValueAsInt
	int32_t GetValueAsInt(FName& KeyName);                                                                                   // [0x41446a0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.BlackboardComponent.GetValueAsFloat
	float GetValueAsFloat(FName& KeyName);                                                                                   // [0x4144600] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.BlackboardComponent.GetValueAsEnum
	char GetValueAsEnum(FName& KeyName);                                                                                     // [0x4144560] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.BlackboardComponent.GetValueAsClass
	UClass* GetValueAsClass(FName& KeyName);                                                                                 // [0x41444c0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.BlackboardComponent.GetValueAsBool
	bool GetValueAsBool(FName& KeyName);                                                                                     // [0x4144420] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.BlackboardComponent.GetRotationFromEntry
	bool GetRotationFromEntry(FName& KeyName, FRotator& ResultRotation);                                                     // [0x4144330] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.BlackboardComponent.GetLocationFromEntry
	bool GetLocationFromEntry(FName& KeyName, FVector& ResultLocation);                                                      // [0x4144240] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.BlackboardComponent.ClearValue
	void ClearValue(FName& KeyName);                                                                                         // [0x4144180] Final|Native|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	void ReceiveObserverDeactivatedAI(AAIController* OwnerController, APawn* ControlledPawn);                                // [0x2649560] Event|Protected|BlueprintEvent 
	// Function /Script/AIModule.BTDecorator_BlueprintBase.ReceiveObserverDeactivated
	void ReceiveObserverDeactivated(AActor* OwnerActor);                                                                     // [0x2649560] Event|Protected|BlueprintEvent 
	// Function /Script/AIModule.BTDecorator_BlueprintBase.ReceiveObserverActivatedAI
	void ReceiveObserverActivatedAI(AAIController* OwnerController, APawn* ControlledPawn);                                  // [0x2649560] Event|Protected|BlueprintEvent 
	// Function /Script/AIModule.BTDecorator_BlueprintBase.ReceiveObserverActivated
	void ReceiveObserverActivated(AActor* OwnerActor);                                                                       // [0x2649560] Event|Protected|BlueprintEvent 
	// Function /Script/AIModule.BTDecorator_BlueprintBase.ReceiveExecutionStartAI
	void ReceiveExecutionStartAI(AAIController* OwnerController, APawn* ControlledPawn);                                     // [0x2649560] Event|Protected|BlueprintEvent 
	// Function /Script/AIModule.BTDecorator_BlueprintBase.ReceiveExecutionStart
	void ReceiveExecutionStart(AActor* OwnerActor);                                                                          // [0x2649560] Event|Protected|BlueprintEvent 
	// Function /Script/AIModule.BTDecorator_BlueprintBase.ReceiveExecutionFinishAI
	void ReceiveExecutionFinishAI(AAIController* OwnerController, APawn* ControlledPawn, TEnumAsByte<EBTNodeResult> NodeResult); // [0x2649560] Event|Protected|BlueprintEvent 
	// Function /Script/AIModule.BTDecorator_BlueprintBase.ReceiveExecutionFinish
	void ReceiveExecutionFinish(AActor* OwnerActor, TEnumAsByte<EBTNodeResult> NodeResult);                                  // [0x2649560] Event|Protected|BlueprintEvent 
	// Function /Script/AIModule.BTDecorator_BlueprintBase.PerformConditionCheckAI
	bool PerformConditionCheckAI(AAIController* OwnerController, APawn* ControlledPawn);                                     // [0x2649560] Event|Protected|BlueprintEvent 
	// Function /Script/AIModule.BTDecorator_BlueprintBase.PerformConditionCheck
	bool PerformConditionCheck(AActor* OwnerActor);                                                                          // [0x2649560] Event|Protected|BlueprintEvent 
	// Function /Script/AIModule.BTDecorator_BlueprintBase.IsDecoratorObserverActive
	bool IsDecoratorObserverActive();                                                                                        // [0x4144af0] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.BTDecorator_BlueprintBase.IsDecoratorExecutionActive
	bool IsDecoratorExecutionActive();                                                                                       // [0x4144ac0] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	void SetFinishOnMessageWithId(FName MessageName, int32_t RequestID);                                                     // [0x4149ba0] Final|Native|Protected|BlueprintCallable 
	// Function /Script/AIModule.BTTask_BlueprintBase.SetFinishOnMessage
	void SetFinishOnMessage(FName MessageName);                                                                              // [0x4149b10] Final|Native|Protected|BlueprintCallable 
	...
	void ReceiveExecuteAI(AAIController* OwnerController, APawn* ControlledPawn);                                            // [0x2649560] Event|Protected|BlueprintEvent 
	// Function /Script/AIModule.BTTask_BlueprintBase.ReceiveExecute
	void ReceiveExecute(AActor* OwnerActor);                                                                                 // [0x2649560] Event|Protected|BlueprintEvent 
	// Function /Script/AIModule.BTTask_BlueprintBase.ReceiveAbortAI
	void ReceiveAbortAI(AAIController* OwnerController, APawn* ControlledPawn);                                              // [0x2649560] Event|Protected|BlueprintEvent 
	// Function /Script/AIModule.BTTask_BlueprintBase.ReceiveAbort
	void ReceiveAbort(AActor* OwnerActor);                                                                                   // [0x2649560] Event|Protected|BlueprintEvent 
	// Function /Script/AIModule.BTTask_BlueprintBase.IsTaskExecuting
	bool IsTaskExecuting();                                                                                                  // [0x4148de0] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.BTTask_BlueprintBase.IsTaskAborting
	bool IsTaskAborting();                                                                                                   // [0x4148db0] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.BTTask_BlueprintBase.FinishExecute
	void FinishExecute(bool bSuccess);                                                                                       // [0x4148060] Final|Native|Protected|BlueprintCallable 
	// Function /Script/AIModule.BTTask_BlueprintBase.FinishAbort
	void FinishAbort();                                                                                                      // [0x4148040] Final|Native|Protected|BlueprintCallable 
};
...
public:
	...
	UObject* GetQuerier();                                                                                                   // [0x414d070] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.EnvQueryGenerator_BlueprintBase.DoItemGeneration
	void DoItemGeneration(TArray<FVector>& ContextLocations);                                                                // [0x2649560] Event|Public|HasOutParms|BlueprintEvent|Const 
	// Function /Script/AIModule.EnvQueryGenerator_BlueprintBase.AddGeneratedVector
	void AddGeneratedVector(FVector GeneratedVector);                                                                        // [0x414cfe0] Final|Native|Public|HasDefaults|BlueprintCallable|Const 
	// Function /Script/AIModule.EnvQueryGenerator_BlueprintBase.AddGeneratedActor
	void AddGeneratedActor(AActor* GeneratedActor);                                                                          // [0x414cf50] Final|Native|Public|BlueprintCallable|Const 
};
...
public:
	...
	void SetNamedParam(FName ParamName, float Value);                                                                        // [0x4150c20] Final|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.EnvQueryInstanceBlueprintWrapper.GetResultsAsLocations
	TArray<FVector> GetResultsAsLocations();                                                                                 // [0x4150a10] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.EnvQueryInstanceBlueprintWrapper.GetResultsAsActors
	TArray<AActor*> GetResultsAsActors();                                                                                    // [0x4150990] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.EnvQueryInstanceBlueprintWrapper.GetQueryResultsAsLocations
	bool GetQueryResultsAsLocations(TArray<FVector>& ResultLocations);                                                       // [0x41508d0] Final|Native|Public|HasOutParms|BlueprintCallable|Const 
	// Function /Script/AIModule.EnvQueryInstanceBlueprintWrapper.GetQueryResultsAsActors
	bool GetQueryResultsAsActors(TArray<AActor*>& ResultActors);                                                             // [0x4150810] Final|Native|Public|HasOutParms|BlueprintCallable|Const 
	// Function /Script/AIModule.EnvQueryInstanceBlueprintWrapper.GetItemScore
	float GetItemScore(int32_t ItemIndex);                                                                                   // [0x4150770] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.EnvQueryInstanceBlueprintWrapper.EQSQueryDoneSignature__DelegateSignature
	void EQSQueryDoneSignature__DelegateSignature(UEnvQueryInstanceBlueprintWrapper* QueryInstance, TEnumAsByte<EEnvQueryStatus> QueryStatus); // [0x2649560] MulticastDelegate|Public|Delegate 
};
...
public:
	...
	TArray<UEnvQueryContext*>                          LocalContexts;                                              // 0x00C0   (0x0010)  
	TArray<UEnvQueryInstanceBlueprintWrapper*>         GCShieldedWrappers;                                         // 0x00D0   (0x0010)  
	...
	UEnvQueryInstanceBlueprintWrapper* RunEQSQuery(UObject* WorldContextObject, UEnvQuery* QueryTemplate, UObject* Querier, TEnumAsByte<EEnvQueryRunMode> RunMode, UClass* WrapperClass); // [0x4150a90] Final|Native|Static|Public|BlueprintCallable 
};
...
{ 
public:
	UNavLocalGridManager*                              GridManager;                                                // 0x0260   (0x0008)  
	unsigned char                                      UnknownData00_6[0x28];                                      // 0x0268   (0x0028)  MISSED
};
...
public:
	...
	TEnumAsByte<EAIRequestPriority> GetActionPriority();                                                                     // [0x204af70] Final|Native|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/AIModule.PawnAction.Finish
	void Finish(TEnumAsByte<EPawnActionResult> WithResult);                                                                  // [0x4153a40] Native|Protected|BlueprintCallable 
	// Function /Script/AIModule.PawnAction.CreateActionInstance
	UPawnAction* CreateActionInstance(UObject* WorldContextObject, UClass* ActionClass);                                     // [0x41537e0] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	bool K2_PushAction(UPawnAction* NewAction, TEnumAsByte<EAIRequestPriority> Priority, UObject* Instigator);               // [0x4153e10] Final|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.PawnActionsComponent.K2_PerformAction
	bool K2_PerformAction(APawn* Pawn, UPawnAction* Action, TEnumAsByte<EAIRequestPriority> Priority);                       // [0x4153d10] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/AIModule.PawnActionsComponent.K2_ForceAbortAction
	TEnumAsByte<EPawnActionAbortState> K2_ForceAbortAction(UPawnAction* ActionToAbort);                                      // [0x4153c70] Final|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.PawnActionsComponent.K2_AbortAction
	TEnumAsByte<EPawnActionAbortState> K2_AbortAction(UPawnAction* ActionToAbort);                                           // [0x4153bd0] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	void SetSensingUpdatesEnabled(bool bEnabled);                                                                            // [0x41544d0] BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.PawnSensingComponent.SetSensingInterval
	void SetSensingInterval(float NewSensingInterval);                                                                       // [0x4154440] BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.PawnSensingComponent.SetPeripheralVisionAngle
	void SetPeripheralVisionAngle(float NewPeripheralVisionAngle);                                                           // [0x41543b0] BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.PawnSensingComponent.SeePawnDelegate__DelegateSignature
	void SeePawnDelegate__DelegateSignature(APawn* Pawn);                                                                    // [0x2649560] MulticastDelegate|Public|Delegate 
	// Function /Script/AIModule.PawnSensingComponent.HearNoiseDelegate__DelegateSignature
	void HearNoiseDelegate__DelegateSignature(APawn* Instigator, FVector& Location, float Volume);                           // [0x2649560] MulticastDelegate|Public|Delegate|HasOutParms|HasDefaults 
	// Function /Script/AIModule.PawnSensingComponent.GetPeripheralVisionCosine
	float GetPeripheralVisionCosine();                                                                                       // [0x4153b50] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.PawnSensingComponent.GetPeripheralVisionAngle
	float GetPeripheralVisionAngle();                                                                                        // [0x4153b30] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
