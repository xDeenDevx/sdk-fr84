...
struct FAnimNode_KawaiiPhysics : FAnimNode_SkeletalControlBase {
	...
	struct UKawaiiPhysicsLimitsDataAsset* LimitsDataAsset; // 0x178(0x08)
	struct TArray<struct FSphericalLimit> SphericalLimitsData; // 0x180(0x10)
	struct TArray<struct FCapsuleLimit> CapsuleLimitsData; // 0x190(0x10)
	struct TArray<struct FPlanarLimit> PlanarLimitsData; // 0x1a0(0x10)
	float TeleportDistanceThreshold; // 0x1b0(0x04)
	float TeleportRotationThreshold; // 0x1b4(0x04)
	struct FVector Gravity; // 0x1b8(0x0c)
	bool bEnableWind; // 0x1c4(0x01)
	char pad_1C5[0x3]; // 0x1c5(0x03)
	float WindScale; // 0x1c8(0x04)
	char pad_1CC[0x4]; // 0x1cc(0x04)
	struct TArray<struct FKawaiiPhysicsModifyBone> ModifyBones; // 0x1d0(0x10)
	float TotalBoneLength; // 0x1e0(0x04)
