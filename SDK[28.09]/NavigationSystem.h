...
public:
	...
	void SetNavigationRelevancy(bool bRelevant);                                                                             // [0x40b7060] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	void SetAreaClass(UClass* NewAreaClass);                                                                                 // [0x40b6fd0] Final|Native|Public|BlueprintCallable 
};
...
/// Size: 0x01E0 (0x000228 - 0x000408)
class ANavigationData : public AActor
{ 
public:
	unsigned char                                      UnknownData00_2[0x8];                                       // 0x0228   (0x0008)  MISSED
	UPrimitiveComponent*                               RenderingComp;                                              // 0x0230   (0x0008)  
	FNavDataConfig                                     NavDataConfig;                                              // 0x0238   (0x0078)  
	bool                                               bEnableDrawing;                                             // 0x02B0:0 (0x0001)  
	bool                                               bForceRebuildOnLoad;                                        // 0x02B0:1 (0x0001)  
	bool                                               bAutoDestroyWhenNoNavigation;                               // 0x02B0:2 (0x0001)  
	bool                                               bCanBeMainNavData;                                          // 0x02B0:3 (0x0001)  
	bool                                               bCanSpawnOnRebuild;                                         // 0x02B0:4 (0x0001)  
	bool                                               bRebuildAtRuntime;                                          // 0x02B0:5 (0x0001)  
	unsigned char                                      UnknownData01_4[0x3];                                       // 0x02B1   (0x0003)  MISSED
	ERuntimeGenerationType                             RuntimeGeneration;                                          // 0x02B4   (0x0001)  
	unsigned char                                      UnknownData02_5[0x3];                                       // 0x02B5   (0x0003)  MISSED
	float                                              ObservedPathsTickInterval;                                  // 0x02B8   (0x0004)  
	uint32_t                                           DataVersion;                                                // 0x02BC   (0x0004)  
	unsigned char                                      UnknownData03_5[0xE0];                                      // 0x02C0   (0x00E0)  MISSED
	TArray<FSupportedAreaData>                         SupportedAreas;                                             // 0x03A0   (0x0010)  
	unsigned char                                      UnknownData04_6[0x58];                                      // 0x03B0   (0x0058)  MISSED
};
...
{ 
public:
	FNavGraphNode                                      Node;                                                       // 0x0318   (0x0018)  
	UNavigationGraphNodeComponent*                     NextNodeComponent;                                          // 0x0330   (0x0008)  
	UNavigationGraphNodeComponent*                     PrevNodeComponent;                                          // 0x0338   (0x0008)  
};
...
public:
	...
	bool IsValid();                                                                                                          // [0x40b4160] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/NavigationSystem.NavigationPath.IsStringPulled
	bool IsStringPulled();                                                                                                   // [0x2106880] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/NavigationSystem.NavigationPath.IsPartial
	bool IsPartial();                                                                                                        // [0x40b4130] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/NavigationSystem.NavigationPath.GetPathLength
	float GetPathLength();                                                                                                   // [0x40b39f0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/NavigationSystem.NavigationPath.GetPathCost
	float GetPathCost();                                                                                                     // [0x40b3790] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/NavigationSystem.NavigationPath.GetDebugString
	FString GetDebugString();                                                                                                // [0x40b3680] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/NavigationSystem.NavigationPath.EnableRecalculationOnInvalidation
	void EnableRecalculationOnInvalidation(TEnumAsByte<ENavigationOptionFlag> DoRecalculation);                              // [0x40b3220] Final|Native|Public|BlueprintCallable 
	// Function /Script/NavigationSystem.NavigationPath.EnableDebugDrawing
	void EnableDebugDrawing(bool bShouldDrawDebugData, FLinearColor PathColor);                                              // [0x40b3140] Final|Native|Public|HasDefaults|BlueprintCallable 
};
...
public:
	...
	bool                                               bGenerateNavigationOnlyAroundNavigationInvokers;            // 0x0070:0 (0x0001)  
	...
	unsigned char                                      UnknownData06_5[0xEC];                                      // 0x00E0   (0x00EC)  MISSED
	FNavigationSystemRunMode                           OperationMode;                                              // 0x01CC   (0x0001)  
	unsigned char                                      UnknownData07_5[0x357];                                     // 0x01CD   (0x0357)  MISSED
	float                                              DirtyAreasUpdateFreq;                                       // 0x0524   (0x0004)  
	unsigned char                                      UnknownData08_6[0x20];                                      // 0x0528   (0x0020)  MISSED


	/// Functions
	// Function /Script/NavigationSystem.NavigationSystemV1.UnregisterNavigationInvoker
	void UnregisterNavigationInvoker(AActor* Invoker);                                                                       // [0x40b5090] Final|Native|Public|BlueprintCallable 
	// Function /Script/NavigationSystem.NavigationSystemV1.SimpleMoveToLocation
	void SimpleMoveToLocation(AController* Controller, FVector& Goal);                                                       // [0x40b4fd0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/NavigationSystem.NavigationSystemV1.SimpleMoveToActor
	void SimpleMoveToActor(AController* Controller, AActor* Goal);                                                           // [0x20a86f0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/NavigationSystem.NavigationSystemV1.SetMaxSimultaneousTileGenerationJobsCount
	void SetMaxSimultaneousTileGenerationJobsCount(int32_t MaxNumberOfJobs);                                                 // [0x40b4f40] Final|Native|Public|BlueprintCallable 
	// Function /Script/NavigationSystem.NavigationSystemV1.SetGeometryGatheringMode
	void SetGeometryGatheringMode(ENavDataGatheringModeConfig NewMode);                                                      // [0x40b4ec0] Final|Native|Public|BlueprintCallable 
	// Function /Script/NavigationSystem.NavigationSystemV1.ResetMaxSimultaneousTileGenerationJobsCount
	void ResetMaxSimultaneousTileGenerationJobsCount();                                                                      // [0x40b4ea0] Final|Native|Public|BlueprintCallable 
	// Function /Script/NavigationSystem.NavigationSystemV1.RegisterNavigationInvoker
	void RegisterNavigationInvoker(AActor* Invoker, float TileGenerationRadius, float TileRemovalRadius);                    // [0x40b4d90] Final|Native|Public|BlueprintCallable 
	// Function /Script/NavigationSystem.NavigationSystemV1.ProjectPointToNavigation
	FVector ProjectPointToNavigation(UObject* WorldContextObject, FVector& Point, ANavigationData* NavData, UClass* FilterClass, FVector QueryExtent); // [0x40b4ba0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/NavigationSystem.NavigationSystemV1.OnNavigationBoundsUpdated
	void OnNavigationBoundsUpdated(ANavMeshBoundsVolume* NavVolume);                                                         // [0x40b4b10] Final|Native|Public|BlueprintCallable 
	// Function /Script/NavigationSystem.NavigationSystemV1.NavigationRaycast
	bool NavigationRaycast(UObject* WorldContextObject, FVector& RayStart, FVector& RayEnd, FVector& HitLocation, UClass* FilterClass, AController* Querier); // [0x40b48e0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/NavigationSystem.NavigationSystemV1.K2_ReplaceAreaInOctreeData
	bool K2_ReplaceAreaInOctreeData(UObject* Object, UClass* OldArea, UClass* NewArea);                                      // [0x40b47d0] Final|Native|Public|BlueprintCallable 
	// Function /Script/NavigationSystem.NavigationSystemV1.K2_ProjectPointToNavigation
	bool K2_ProjectPointToNavigation(UObject* WorldContextObject, FVector& Point, FVector& ProjectedLocation, ANavigationData* NavData, UClass* FilterClass, FVector QueryExtent); // [0x40b45d0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/NavigationSystem.NavigationSystemV1.K2_GetRandomReachablePointInRadius
	bool K2_GetRandomReachablePointInRadius(UObject* WorldContextObject, FVector& Origin, FVector& RandomLocation, float Radius, ANavigationData* NavData, UClass* FilterClass); // [0x40b43b0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/NavigationSystem.NavigationSystemV1.K2_GetRandomPointInNavigableRadius
	bool K2_GetRandomPointInNavigableRadius(UObject* WorldContextObject, FVector& Origin, FVector& RandomLocation, float Radius, ANavigationData* NavData, UClass* FilterClass); // [0x40b4190] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/NavigationSystem.NavigationSystemV1.K2_GetRandomLocationInNavigableRadius
	bool K2_GetRandomLocationInNavigableRadius(UObject* WorldContextObject, FVector& Origin, FVector& RandomLocation, float Radius, ANavigationData* NavData, UClass* FilterClass); // [0x40b4190] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/NavigationSystem.NavigationSystemV1.IsNavigationBeingBuiltOrLocked
	bool IsNavigationBeingBuiltOrLocked(UObject* WorldContextObject);                                                        // [0x40b40a0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/NavigationSystem.NavigationSystemV1.IsNavigationBeingBuilt
	bool IsNavigationBeingBuilt(UObject* WorldContextObject);                                                                // [0x40b4010] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/NavigationSystem.NavigationSystemV1.GetRandomReachablePointInRadius
	FVector GetRandomReachablePointInRadius(UObject* WorldContextObject, FVector& Origin, float Radius, ANavigationData* NavData, UClass* FilterClass); // [0x40b3e30] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/NavigationSystem.NavigationSystemV1.GetRandomPointInNavigableRadius
	FVector GetRandomPointInNavigableRadius(UObject* WorldContextObject, FVector& Origin, float Radius, ANavigationData* NavData, UClass* FilterClass); // [0x40b3c50] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/NavigationSystem.NavigationSystemV1.GetPathLength
	TEnumAsByte<ENavigationQueryResult> GetPathLength(UObject* WorldContextObject, FVector& PathStart, FVector& PathEnd, float& PathLength, ANavigationData* NavData, UClass* FilterClass); // [0x40b3a20] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/NavigationSystem.NavigationSystemV1.GetPathCost
	TEnumAsByte<ENavigationQueryResult> GetPathCost(UObject* WorldContextObject, FVector& PathStart, FVector& PathEnd, float& PathCost, ANavigationData* NavData, UClass* FilterClass); // [0x40b37c0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/NavigationSystem.NavigationSystemV1.GetNavigationSystem
	UNavigationSystemV1* GetNavigationSystem(UObject* WorldContextObject);                                                   // [0x40b3700] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/NavigationSystem.NavigationSystemV1.FindPathToLocationSynchronously
	UNavigationPath* FindPathToLocationSynchronously(UObject* WorldContextObject, FVector& PathStart, FVector& PathEnd, AActor* PathfindingContext, UClass* FilterClass); // [0x40b34b0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/NavigationSystem.NavigationSystemV1.FindPathToActorSynchronously
	UNavigationPath* FindPathToActorSynchronously(UObject* WorldContextObject, FVector& PathStart, AActor* GoalActor, float TetherDistance, AActor* PathfindingContext, UClass* FilterClass); // [0x40b32a0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
};
...
public:
	...
	TArray<FNavigationLink>                            Links;                                                      // 0x0548   (0x0010)  
...
public:
	...
	void SetAreaClass(UClass* NewAreaClass);                                                                                 // [0x40b6f40] Final|Native|Public|BlueprintCallable 
};
...
{ 
public:
	bool                                               bDrawTriangleEdges;                                         // 0x0408:0 (0x0001)  
	bool                                               bDrawPolyEdges;                                             // 0x0408:1 (0x0001)  
	bool                                               bDrawFilledPolys;                                           // 0x0408:2 (0x0001)  
	bool                                               bDrawNavMeshEdges;                                          // 0x0408:3 (0x0001)  
	bool                                               bDrawTileBounds;                                            // 0x0408:4 (0x0001)  
	bool                                               bDrawPathCollidingGeometry;                                 // 0x0408:5 (0x0001)  
	bool                                               bDrawTileLabels;                                            // 0x0408:6 (0x0001)  
	bool                                               bDrawPolygonLabels;                                         // 0x0408:7 (0x0001)  
	bool                                               bDrawDefaultPolygonCost;                                    // 0x0409:0 (0x0001)  
	bool                                               bDrawLabelsOnPathNodes;                                     // 0x0409:1 (0x0001)  
	bool                                               bDrawNavLinks;                                              // 0x0409:2 (0x0001)  
	bool                                               bDrawFailedNavLinks;                                        // 0x0409:3 (0x0001)  
	bool                                               bDrawClusters;                                              // 0x0409:4 (0x0001)  
	bool                                               bDrawOctree;                                                // 0x0409:5 (0x0001)  
	bool                                               bDrawOctreeDetails;                                         // 0x0409:6 (0x0001)  
	bool                                               bDrawMarkedForbiddenPolys;                                  // 0x0409:7 (0x0001)  
	bool                                               bDistinctlyDrawTilesBeingBuilt;                             // 0x040A:0 (0x0001)  
	bool                                               bDrawNavMesh;                                               // 0x040A:1 (0x0001)  
	unsigned char                                      UnknownData00_4[0x1];                                       // 0x040B   (0x0001)  MISSED
	float                                              DrawOffset;                                                 // 0x040C   (0x0004)  
	bool                                               bFixedTilePoolSize;                                         // 0x0410:0 (0x0001)  
	unsigned char                                      UnknownData01_4[0x3];                                       // 0x0411   (0x0003)  MISSED
	int32_t                                            TilePoolSize;                                               // 0x0414   (0x0004)  
	float                                              TileSizeUU;                                                 // 0x0418   (0x0004)  
	float                                              CellSize;                                                   // 0x041C   (0x0004)  
	float                                              CellHeight;                                                 // 0x0420   (0x0004)  
	float                                              AgentRadius;                                                // 0x0424   (0x0004)  
	float                                              AgentHeight;                                                // 0x0428   (0x0004)  
	float                                              AgentMaxHeight;                                             // 0x042C   (0x0004)  
	float                                              AgentMaxSlope;                                              // 0x0430   (0x0004)  
	float                                              AgentMaxStepHeight;                                         // 0x0434   (0x0004)  
	float                                              MinRegionArea;                                              // 0x0438   (0x0004)  
	float                                              MergeRegionSize;                                            // 0x043C   (0x0004)  
	float                                              MaxSimplificationError;                                     // 0x0440   (0x0004)  
	int32_t                                            MaxSimultaneousTileGenerationJobsCount;                     // 0x0444   (0x0004)  
	int32_t                                            TileNumberHardLimit;                                        // 0x0448   (0x0004)  
	int32_t                                            PolyRefTileBits;                                            // 0x044C   (0x0004)  
	int32_t                                            PolyRefNavPolyBits;                                         // 0x0450   (0x0004)  
	int32_t                                            PolyRefSaltBits;                                            // 0x0454   (0x0004)  
	FVector                                            NavMeshOriginOffset;                                        // 0x0458   (0x000C)  
	float                                              DefaultDrawDistance;                                        // 0x0464   (0x0004)  
	float                                              DefaultMaxSearchNodes;                                      // 0x0468   (0x0004)  
	float                                              DefaultMaxHierarchicalSearchNodes;                          // 0x046C   (0x0004)  
	TEnumAsByte<ERecastPartitioning>                   RegionPartitioning;                                         // 0x0470   (0x0001)  
	TEnumAsByte<ERecastPartitioning>                   LayerPartitioning;                                          // 0x0471   (0x0001)  
	unsigned char                                      UnknownData02_5[0x2];                                       // 0x0472   (0x0002)  MISSED
	int32_t                                            RegionChunkSplits;                                          // 0x0474   (0x0004)  
	int32_t                                            LayerChunkSplits;                                           // 0x0478   (0x0004)  
	bool                                               bSortNavigationAreasByCost;                                 // 0x047C:0 (0x0001)  
	bool                                               bPerformVoxelFiltering;                                     // 0x047C:1 (0x0001)  
	bool                                               bMarkLowHeightAreas;                                        // 0x047C:2 (0x0001)  
	bool                                               bFilterLowSpanSequences;                                    // 0x047C:3 (0x0001)  
	bool                                               bFilterLowSpanFromTileCache;                                // 0x047C:4 (0x0001)  
	bool                                               bDoFullyAsyncNavDataGathering;                              // 0x047C:5 (0x0001)  
	bool                                               bUseBetterOffsetsFromCorners;                               // 0x047C:6 (0x0001)  
	bool                                               bStoreEmptyTileLayers;                                      // 0x047C:7 (0x0001)  
	bool                                               bUseVirtualFilters;                                         // 0x047D:0 (0x0001)  
	bool                                               bAllowNavLinkAsPathEnd;                                     // 0x047D:1 (0x0001)  
	bool                                               bUseVoxelCache;                                             // 0x047D:2 (0x0001)  
	unsigned char                                      UnknownData03_4[0x2];                                       // 0x047E   (0x0002)  MISSED
	float                                              TileSetUpdateInterval;                                      // 0x0480   (0x0004)  
	float                                              HeuristicScale;                                             // 0x0484   (0x0004)  
	float                                              VerticalDeviationFromGroundCompensation;                    // 0x0488   (0x0004)  
	unsigned char                                      UnknownData04_6[0x3C];                                      // 0x048C   (0x003C)  MISSED


	/// Functions
	// Function /Script/NavigationSystem.RecastNavMesh.K2_ReplaceAreaInTileBounds
	bool K2_ReplaceAreaInTileBounds(FBox Bounds, UClass* OldArea, UClass* NewArea, bool ReplaceLinks);                       // [0x40b6da0] Final|Native|Public|HasDefaults|BlueprintCallable 
};
...
{ 
	...
	bool                                               bFilterLowSpanSequences;                                    // 0x003C:3 (0x0001)  
	bool                                               bFilterLowSpanFromTileCache;                                // 0x003C:4 (0x0001)  
	bool                                               bFixedTilePoolSize;                                         // 0x003C:5 (0x0001)  
