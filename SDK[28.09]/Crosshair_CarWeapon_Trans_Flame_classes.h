...
struct UCrosshair_CarWeapon_Trans_Flame_C : UVehicleWeaponCrossHairWidget {
	...
	void Construct(); // Function Crosshair_CarWeapon_Trans_Flame.Crosshair_CarWeapon_Trans_Flame_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x2649560
	void OnTransformerWeaponChanged(enum class ETransformerType InType); // Function Crosshair_CarWeapon_Trans_Flame.Crosshair_CarWeapon_Trans_Flame_C.OnTransformerWeaponChanged // (Event|Protected|BlueprintEvent) // @ game+0x2649560
	void OnOverloadStateChanged(bool bEnter); // Function Crosshair_CarWeapon_Trans_Flame.Crosshair_CarWeapon_Trans_Flame_C.OnOverloadStateChanged // (Event|Protected|BlueprintEvent) // @ game+0x2649560
	void OnCrosshairInNormalState(); // Function Crosshair_CarWeapon_Trans_Flame.Crosshair_CarWeapon_Trans_Flame_C.OnCrosshairInNormalState // (Event|Protected|BlueprintEvent) // @ game+0x2649560
	void ExecuteUbergraph_Crosshair_CarWeapon_Trans_Flame(int32_t EntryPoint); // Function Crosshair_CarWeapon_Trans_Flame.Crosshair_CarWeapon_Trans_Flame_C.ExecuteUbergraph_Crosshair_CarWeapon_Trans_Flame // (Final|UbergraphFunction) // @ game+0x2649560
};
