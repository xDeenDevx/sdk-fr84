...
public:
	...
	uint8                                        Pad_2[0x3C0];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_6[0x8];                                        // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_8[0x80];                                       // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_B[0xB8];                                       // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_C[0x30];                                       // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_13[0x40];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_16[0x1D8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_22[0x1E0];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_24[0x10];                                      // Fixing Size After Last Property  [ Dumper-7 ]
