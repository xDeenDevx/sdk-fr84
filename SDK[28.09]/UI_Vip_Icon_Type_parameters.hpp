...
struct UUI_Vip_Icon_Type_C_SetType_Params
{
public:
	...
	uint8                                        Pad_42C[0x1];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class UObject*                               K2Node_Select_Default_1;                           // 0x38(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// 0x1 (0x1 - 0x0)
// Function UI_Vip_Icon_Type.UI_Vip_Icon_Type_C.PreConstruct
struct UUI_Vip_Icon_Type_C_PreConstruct_Params
{
public:
...
struct UUI_Vip_Icon_Type_C_ExecuteUbergraph_UI_Vip_Icon_Type_Params
{
public:
