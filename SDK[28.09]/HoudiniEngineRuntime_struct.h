...
struct FHoudiniAssetBlueprintInstanceData : FActorComponentInstanceData {
	struct UHoudiniAsset* HoudiniAsset; // 0x58(0x08)
	int32_t AssetId; // 0x60(0x04)
	enum class EHoudiniAssetState AssetState; // 0x64(0x01)
	char pad_65[0x3]; // 0x65(0x03)
	uint32_t SubAssetIndex; // 0x68(0x04)
	uint32_t AssetCookCount; // 0x6c(0x04)
	bool bHasBeenLoaded; // 0x70(0x01)
	bool bHasBeenDuplicated; // 0x71(0x01)
	bool bPendingDelete; // 0x72(0x01)
	bool bRecookRequested; // 0x73(0x01)
	bool bRebuildRequested; // 0x74(0x01)
	bool bEnableCooking; // 0x75(0x01)
	bool bForceNeedUpdate; // 0x76(0x01)
	bool bLastCookSuccess; // 0x77(0x01)
	struct FGuid ComponentGUID; // 0x78(0x10)
	struct FGuid HapiGUID; // 0x88(0x10)
	bool bRegisteredComponentTemplate; // 0x98(0x01)
...
struct FHoudiniInputLandscapeTransferParams {
	enum class ETransferHeightMode TransferHeightMode; // 0x00(0x01)
	char pad_1[0x7]; // 0x01(0x07)
	struct TSet<struct FName> HeightSpecifiedLayerNames; // 0x08(0x50)
	struct FName HeightUnderSpecifiedLayerName; // 0x58(0x08)
	enum class ETransferLayerMode TransferLayerMode; // 0x60(0x01)
	char pad_61[0x7]; // 0x61(0x07)
	struct TSet<struct FName> LayerSpecifiedLayerNames; // 0x68(0x50)
	struct FName LayerUnderSpecifiedLayerName; // 0xb8(0x08)
	bool bTransferWeightmap; // 0xc0(0x01)
...
struct FHoudiniInstancedOutput {
	struct TSoftObjectPtr<UObject> OriginalObject; // 0x00(0x28)
	...
	bool bChanged; // 0x80(0x01)
	bool bStale; // 0x81(0x01)
...
struct FHoudiniStaticMeshGenerationProperties {
	...
	enum class ECollisionTraceFlag GeneratedCollisionTraceFlag; // 0x140(0x01)
	char pad_141[0x3]; // 0x141(0x03)
	int32_t GeneratedLightMapResolution; // 0x144(0x04)
	struct FWalkableSlopeOverride GeneratedWalkableSlopeOverride; // 0x148(0x10)
	int32_t GeneratedLightMapCoordinateIndex; // 0x158(0x04)
	char bGeneratedUseMaximumStreamingTexelRatio : 1; // 0x15c(0x01)
	char pad_15C_1 : 7; // 0x15c(0x01)
	char pad_15D[0x3]; // 0x15d(0x03)
	float GeneratedStreamingDistanceMultiplier; // 0x160(0x04)
	char pad_164[0x4]; // 0x164(0x04)
	struct UFoliageType_InstancedStaticMesh* GeneratedFoliageDefaultSettings; // 0x168(0x08)
