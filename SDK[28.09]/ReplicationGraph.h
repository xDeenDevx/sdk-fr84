...
public:
	...
	TArray<UReplicationGraphNode*>                     PostReplicateNodes;                                         // 0x00B8   (0x0010)  
	unsigned char                                      UnknownData01_5[0x3C0];                                     // 0x00C8   (0x03C0)  MISSED
	TMap<UNetConnection*, FClassExtraReplicatedInfo>   ConnectionInfos;                                            // 0x0488   (0x0050)  
	unsigned char                                      UnknownData02_6[0x28];                                      // 0x04D8   (0x0028)  MISSED
};
...
{ 
public:
	UReplicationGraphNode_GridSpatialization2D*        GridNode;                                                   // 0x04F8   (0x0008)  
	UReplicationGraphNode_ActorList*                   AlwaysRelevantNode;                                         // 0x0500   (0x0008)  
	TArray<FConnectionAlwaysRelevantNodePair>          AlwaysRelevantForConnectionList;                            // 0x0508   (0x0010)  
	TArray<AActor*>                                    ActorsWithoutNetConnection;                                 // 0x0518   (0x0010)  
	unsigned char                                      UnknownData00_6[0x8];                                       // 0x0528   (0x0008)  MISSED
};
...
{ 
public:
	unsigned char                                      UnknownData00_1[0x78];                                      // 0x00D0   (0x0078)  MISSED
};
...
public:
	...
	unsigned char                                      UnknownData00_5[0x1E0];                                     // 0x0030   (0x01E0)  MISSED
	AReplicationGraphDebugActor*                       DebugActor;                                                 // 0x0210   (0x0008)  
	unsigned char                                      UnknownData01_5[0x10];                                      // 0x0218   (0x0010)  MISSED
	TArray<FLastLocationGatherInfo>                    LastGatherLocations;                                        // 0x0228   (0x0010)  
	unsigned char                                      UnknownData02_5[0x8];                                       // 0x0238   (0x0008)  MISSED
	TArray<UReplicationGraphNode*>                     ConnectionGraphNodes;                                       // 0x0240   (0x0010)  
	UReplicationGraphNode_TearOff_ForConnection*       TearOffNode;                                                // 0x0250   (0x0008)  
	unsigned char                                      UnknownData03_6[0x80];                                      // 0x0258   (0x0080)  MISSED
};
...
{ 
public:
	UReplicationGraph*                                 ReplicationGraph;                                           // 0x0228   (0x0008)  
	UNetReplicationGraphConnection*                    ConnectionManager;                                          // 0x0230   (0x0008)  


	/// Functions
	// Function /Script/ReplicationGraph.ReplicationGraphDebugActor.ServerStopDebugging
	void ServerStopDebugging();                                                                                              // [0x816c00] Net|NetReliableNative|Event|Public|NetServer 
	// Function /Script/ReplicationGraph.ReplicationGraphDebugActor.ServerStartDebugging
	void ServerStartDebugging();                                                                                             // [0x816be0] Net|NetReliableNative|Event|Public|NetServer 
	// Function /Script/ReplicationGraph.ReplicationGraphDebugActor.ServerSetPeriodFrameForClass
	void ServerSetPeriodFrameForClass(UClass* Class, int32_t PeriodFrame);                                                   // [0x816b10] Net|NetReliableNative|Event|Public|NetServer 
	// Function /Script/ReplicationGraph.ReplicationGraphDebugActor.ServerSetCullDistanceForClass
	void ServerSetCullDistanceForClass(UClass* Class, float CullDistance);                                                   // [0x816a30] Net|NetReliableNative|Event|Public|NetServer 
	// Function /Script/ReplicationGraph.ReplicationGraphDebugActor.ServerSetConditionalActorBreakpoint
	void ServerSetConditionalActorBreakpoint(AActor* Actor);                                                                 // [0x8169a0] Net|NetReliableNative|Event|Public|NetServer 
	// Function /Script/ReplicationGraph.ReplicationGraphDebugActor.ServerPrintCullDistances
	void ServerPrintCullDistances();                                                                                         // [0x816980] Net|NetReliableNative|Event|Public|NetServer 
	// Function /Script/ReplicationGraph.ReplicationGraphDebugActor.ServerPrintAllActorInfo
	void ServerPrintAllActorInfo(FString str);                                                                               // [0x8168e0] Net|NetReliableNative|Event|Public|NetServer 
	// Function /Script/ReplicationGraph.ReplicationGraphDebugActor.ServerCellInfo
	void ServerCellInfo();                                                                                                   // [0x8168c0] Net|NetReliableNative|Event|Public|NetServer 
	// Function /Script/ReplicationGraph.ReplicationGraphDebugActor.ClientCellInfo
	void ClientCellInfo(FVector CellLocation, FVector CellExtent, TArray<AActor*> Actors);                                   // [0x816770] Net|NetReliableNative|Event|Public|HasDefaults|NetClient 
};
...
/// Struct /Script/ReplicationGraph.ClassExtraReplicatedInfo
/// Size: 0x0050 (0x000000 - 0x000050)
struct FClassExtraReplicatedInfo
{ 
	TMap<UClass*, int32_t>                             ClassActorsMaxReplicatedNum;                                // 0x0000   (0x0050)  
};
