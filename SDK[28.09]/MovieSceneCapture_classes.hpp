...
{
public:
	uint8                                        Pad_DD8[0x28];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_DF0[0x28];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_E03[0x20];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_EB7[0x70];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_ECB[0xE];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_F2B[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_F3C[0x6];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_F3D[0x110];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_F41[0xB];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1018[0x78];                                    // Fixing Size Of Struct [ Dumper-7 ]
