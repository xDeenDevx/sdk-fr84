...
{
public:
	uint8                                        Pad_48C[0x4C];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_492[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_494[0x38];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_4A0[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_4D8[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_4F0[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
