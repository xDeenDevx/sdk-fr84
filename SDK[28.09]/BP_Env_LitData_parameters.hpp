...
struct ABP_Env_LitData_C_Toggle_Env_Lighting_Params
{
public:
	bool                                         bUseDefaultLight;                                  // 0x0(0x1)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_10A4[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class ASphereReflectionCapture*              NewLocalVar_0;                                     // 0x8(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TArray<class ASphereReflectionCapture*>      CallFunc_GetAllActorsOfClass_OutActors;            // 0x30(0x10)(ReferenceParm, HasGetValueTypeHash)
	class ASphereReflectionCapture*              CallFunc_Array_Get_Item;                           // 0x40(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TArray<class ADirectionalLight*>             CallFunc_GetAllActorsOfClass_OutActors_1;          // 0x58(0x10)(ReferenceParm, HasGetValueTypeHash)
	class ADirectionalLight*                     CallFunc_Array_Get_Item_1;                         // 0x68(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class FName                                  Temp_name_Variable;                                // 0x7C(0x8)(ConstParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_10A9[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<class ASkyLight*>                     CallFunc_GetAllActorsOfClass_OutActors_2;          // 0x88(0x10)(ReferenceParm, HasGetValueTypeHash)
	class ASkyLight*                             CallFunc_Array_Get_Item_2;                         // 0x98(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class USceneComponent*                       CallFunc_K2_GetRootComponent_ReturnValue_1;        // 0xC0(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
{
public:
	struct FStr_EdgeLightSetting                 EdgeLightSetting;                                  // 0x0(0x30)(BlueprintVisible, BlueprintReadOnly, Parm, NoDestructor, HasGetValueTypeHash)
...
struct ABP_Env_LitData_C_Add_or_Set_Light_Data_Element_Params
{
public:
	class FString                                Key;                                               // 0x0(0x10)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm, HasGetValueTypeHash)
	...
	bool                                         CallFunc_Map_Contains_ReturnValue;                 // 0x99(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
public:
	...
	struct FStr_LightData                        CallFunc_Map_Find_Value;                           // 0x18(0x70)(NoDestructor, ContainsInstancedReference, HasGetValueTypeHash)
...
{
public:
	struct FStr_SkyLightSetting                  K2Node_MakeStruct_Str_SkyLightSetting;             // 0x0(0x8)(NoDestructor, HasGetValueTypeHash)
	struct FStr_EdgeLightSetting                 K2Node_MakeStruct_Str_EdgeLightSetting;            // 0x8(0x30)(NoDestructor, HasGetValueTypeHash)
	...
	struct FStr_DirectionalLightSetting          K2Node_MakeStruct_Str_DirectionalLightSetting;     // 0x54(0x38)(NoDestructor)
	struct FStr_LightData                        K2Node_MakeStruct_Str_LightData;                   // 0x8C(0x70)(NoDestructor, ContainsInstancedReference, HasGetValueTypeHash)
};
...
{
public:
	class ADirectionalLight*                     DirectionalLight;                                  // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FStr_DirectionalLightSetting          Str_DirectionalLightSetting;                       // 0x8(0x38)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, NoDestructor)
	class UDirectionalLightComponent*            K2Node_DynamicCast_AsDirectional_Light_Component;  // 0x40(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_DynamicCast_bSuccess;                       // 0x48(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_113A[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FLinearColor                          CallFunc_Conv_ColorToLinearColor_ReturnValue;      // 0x4C(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
{
public:
	class ASkyLight*                             SkyLight;                                          // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FStr_SkyLightSetting                  Str_SkyLightSetting;                               // 0x8(0x8)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_IsValid_ReturnValue;                      // 0x10(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_113B[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FLinearColor                          CallFunc_Conv_ColorToLinearColor_ReturnValue;      // 0x14(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
public:
	...
	struct FStr_LightData                        CallFunc_Map_Find_Value;                           // 0x4(0x70)(NoDestructor, ContainsInstancedReference, HasGetValueTypeHash)
