...
{
public:
	uint8                                        Pad_3A4[0x8];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_3A5[0x6];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<bool>                                 Values;                                            // 0x20(0x10)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_3A6[0x60];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_3BD[0x1];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	bool                                         bHasDefaultValue;                                  // 0x19(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_3D8[0x6];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_3D9[0x60];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_3DB[0x1];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_3F1[0x60];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_3F2[0x60];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_3F7[0x38];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_401[0x5];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_42B[0x2B8];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_439[0x1C];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_43A[0x50];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_43E[0x60];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
