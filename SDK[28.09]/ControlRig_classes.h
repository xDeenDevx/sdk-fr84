...
struct UControlRigComponent : UActorComponent {
	...
	void OnPreInitialize(); // Function ControlRig.ControlRigComponent.OnPreInitialize // (Native|Event|Public|BlueprintEvent) // @ game+0x7d41a0
	void OnPreEvaluate(); // Function ControlRig.ControlRigComponent.OnPreEvaluate // (Native|Event|Public|BlueprintEvent) // @ game+0xc455a0
	void OnPostInitialize(); // Function ControlRig.ControlRigComponent.OnPostInitialize // (Native|Event|Public|BlueprintEvent) // @ game+0xc45580
	void OnPostEvaluate(); // Function ControlRig.ControlRigComponent.OnPostEvaluate // (Native|Event|Public|BlueprintEvent) // @ game+0xc45560
	struct UControlRig* BP_GetControlRig(); // Function ControlRig.ControlRigComponent.BP_GetControlRig // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0xc45530
};
