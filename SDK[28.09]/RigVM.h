...
public:
	...
	unsigned char                                      UnknownData00_5[0x10];                                      // 0x0198   (0x0010)  MISSED
	TArray<FRigVMParameter>                            Parameters;                                                 // 0x01A8   (0x0010)  
	TMap<FName, int32_t>                               ParametersNameMap;                                          // 0x01B8   (0x0050)  
	unsigned char                                      UnknownData01_6[0x38];                                      // 0x0208   (0x0038)  MISSED


	/// Functions
	// Function /Script/RigVM.RigVM.SetParameterValueVector2D
	void SetParameterValueVector2D(FName& InParameterName, FVector2D& InValue, int32_t InArrayIndex);                        // [0x4017770] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/RigVM.RigVM.SetParameterValueVector
	void SetParameterValueVector(FName& InParameterName, FVector& InValue, int32_t InArrayIndex);                            // [0x4017930] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/RigVM.RigVM.SetParameterValueTransform
	void SetParameterValueTransform(FName& InParameterName, FTransform& InValue, int32_t InArrayIndex);                      // [0x4017540] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/RigVM.RigVM.SetParameterValueString
	void SetParameterValueString(FName& InParameterName, FString InValue, int32_t InArrayIndex);                             // [0x4017320] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/RigVM.RigVM.SetParameterValueQuat
	void SetParameterValueQuat(FName& InParameterName, FQuat& InValue, int32_t InArrayIndex);                                // [0x4017150] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/RigVM.RigVM.SetParameterValueName
	void SetParameterValueName(FName& InParameterName, FName& InValue, int32_t InArrayIndex);                                // [0x4016f90] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/RigVM.RigVM.SetParameterValueInt
	void SetParameterValueInt(FName& InParameterName, int32_t InValue, int32_t InArrayIndex);                                // [0x4016de0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/RigVM.RigVM.SetParameterValueFloat
	void SetParameterValueFloat(FName& InParameterName, float InValue, int32_t InArrayIndex);                                // [0x4016c20] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/RigVM.RigVM.SetParameterValueBool
	void SetParameterValueBool(FName& InParameterName, bool InValue, int32_t InArrayIndex);                                  // [0x4016a60] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/RigVM.RigVM.GetRigVMFunctionName
	FString GetRigVMFunctionName(int32_t InFunctionIndex);                                                                   // [0x4016980] Final|Native|Public|Const 
	// Function /Script/RigVM.RigVM.GetParameterValueVector2D
	FVector2D GetParameterValueVector2D(FName& InParameterName, int32_t InArrayIndex);                                       // [0x4016620] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/RigVM.RigVM.GetParameterValueVector
	FVector GetParameterValueVector(FName& InParameterName, int32_t InArrayIndex);                                           // [0x40167d0] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/RigVM.RigVM.GetParameterValueTransform
	FTransform GetParameterValueTransform(FName& InParameterName, int32_t InArrayIndex);                                     // [0x4016430] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/RigVM.RigVM.GetParameterValueString
	FString GetParameterValueString(FName& InParameterName, int32_t InArrayIndex);                                           // [0x40162e0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/RigVM.RigVM.GetParameterValueQuat
	FQuat GetParameterValueQuat(FName& InParameterName, int32_t InArrayIndex);                                               // [0x4016130] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/RigVM.RigVM.GetParameterValueName
	FName GetParameterValueName(FName& InParameterName, int32_t InArrayIndex);                                               // [0x4015f90] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/RigVM.RigVM.GetParameterValueInt
	int32_t GetParameterValueInt(FName& InParameterName, int32_t InArrayIndex);                                              // [0x4015df0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/RigVM.RigVM.GetParameterValueFloat
	float GetParameterValueFloat(FName& InParameterName, int32_t InArrayIndex);                                              // [0x4015c50] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/RigVM.RigVM.GetParameterValueBool
	bool GetParameterValueBool(FName& InParameterName, int32_t InArrayIndex);                                                // [0x4015ab0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/RigVM.RigVM.GetParameterArraySize
	int32_t GetParameterArraySize(FName& InParameterName);                                                                   // [0x4015970] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/RigVM.RigVM.Execute
	bool Execute();                                                                                                          // [0x4015940] Final|Native|Public|BlueprintCallable 
	// Function /Script/RigVM.RigVM.AddRigVMFunction
	int32_t AddRigVMFunction(UScriptStruct* InRigVMStruct, FName& InMethodName);                                             // [0x4015860] Final|Native|Public|HasOutParms 
};
