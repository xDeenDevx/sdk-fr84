...
{ 
public:
	FButtonStyle                                       ButtonStyle;                                                // 0x0030   (0x02B8)  
};

/// Class /Script/Slate.CheckBoxWidgetStyle
/// Size: 0x0610 (0x000030 - 0x000640)
class UCheckBoxWidgetStyle : public USlateWidgetStyleContainerBase
{ 
public:
	FCheckBoxStyle                                     CheckBoxStyle;                                              // 0x0030   (0x0610)  
};
...
{ 
public:
	FComboBoxStyle                                     ComboBoxStyle;                                              // 0x0030   (0x0450)  
};
...
{ 
public:
	FComboButtonStyle                                  ComboButtonStyle;                                           // 0x0030   (0x0418)  
};

/// Class /Script/Slate.EditableTextBoxWidgetStyle
/// Size: 0x08D0 (0x000030 - 0x000900)
class UEditableTextBoxWidgetStyle : public USlateWidgetStyleContainerBase
{ 
public:
	FEditableTextBoxStyle                              EditableTextBoxStyle;                                       // 0x0030   (0x08D0)  
};
...
{ 
public:
	FEditableTextStyle                                 EditableTextStyle;                                          // 0x0030   (0x0258)  
};
...
{ 
public:
	FProgressBarStyle                                  ProgressBarStyle;                                           // 0x0030   (0x01D0)  
};
...
{ 
public:
	FScrollBarStyle                                    ScrollBarStyle;                                             // 0x0030   (0x0560)  
};
...
{ 
public:
	FScrollBoxStyle                                    ScrollBoxStyle;                                             // 0x0030   (0x0268)  
};
...
/// Size: 0x0338 (0x000030 - 0x000368)
class USpinBoxWidgetStyle : public USlateWidgetStyleContainerBase
{ 
public:
	FSpinBoxStyle                                      SpinBoxStyle;                                               // 0x0030   (0x0338)  
};
...
{ 
public:
	FTextBlockStyle                                    TextBlockStyle;                                             // 0x0030   (0x02A8)  
};
