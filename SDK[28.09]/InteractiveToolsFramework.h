...
public:
	...
	UObject*                                           CachedProperties;                                           // 0x0040   (0x0008)  
...
{ 
public:
	FLinearColor                                       Color;                                                      // 0x0540   (0x0010)  
	float                                              HoverSizeMultiplier;                                        // 0x0550   (0x0004)  
	float                                              PixelHitDistanceThreshold;                                  // 0x0554   (0x0004)  
	...
	void UpdateWorldLocalState(bool bWorldIn);                                                                               // [0x3fcf950] Final|Native|Public  
	// Function /Script/InteractiveToolsFramework.GizmoBaseComponent.UpdateHoverState
	void UpdateHoverState(bool bHoveringIn);                                                                                 // [0x3fcf8c0] Final|Native|Public  
};
...
{ 
public:
	FVector                                            Direction;                                                  // 0x0560   (0x000C)  
	float                                              Gap;                                                        // 0x056C   (0x0004)  
	float                                              Length;                                                     // 0x0570   (0x0004)  
	float                                              Thickness;                                                  // 0x0574   (0x0004)  
	unsigned char                                      UnknownData00_6[0x8];                                       // 0x0578   (0x0008)  MISSED
};
...
{ 
public:
	FVector                                            Origin;                                                     // 0x0560   (0x000C)  
	unsigned char                                      UnknownData00_5[0x4];                                       // 0x056C   (0x0004)  MISSED
	...
	unsigned char                                      UnknownData01_6[0xE];                                       // 0x0592   (0x000E)  MISSED
};
...
{ 
public:
	FVector                                            Normal;                                                     // 0x0560   (0x000C)  
	float                                              Radius;                                                     // 0x056C   (0x0004)  
	float                                              Thickness;                                                  // 0x0570   (0x0004)  
	int32_t                                            NumSides;                                                   // 0x0574   (0x0004)  
	bool                                               bViewAligned;                                               // 0x0578   (0x0001)  
	bool                                               bOnlyAllowFrontFacingHits;                                  // 0x0579   (0x0001)  
...
public:
	FVector                                            Normal;                                                     // 0x0560   (0x000C)  
	float                                              HandleSize;                                                 // 0x056C   (0x0004)  
	float                                              Thickness;                                                  // 0x0570   (0x0004)  
	FVector                                            Direction;                                                  // 0x0574   (0x000C)  
	float                                              Length;                                                     // 0x0580   (0x0004)  
	bool                                               bImageScale;                                                // 0x0584   (0x0001)  
	unsigned char                                      UnknownData00_6[0xB];                                       // 0x0585   (0x000B)  MISSED
};
...
{ 
public:
	FVector                                            DirectionX;                                                 // 0x0560   (0x000C)  
	FVector                                            DirectionY;                                                 // 0x056C   (0x000C)  
	float                                              OffsetX;                                                    // 0x0578   (0x0004)  
	float                                              OffsetY;                                                    // 0x057C   (0x0004)  
	float                                              LengthX;                                                    // 0x0580   (0x0004)  
	float                                              LengthY;                                                    // 0x0584   (0x0004)  
	float                                              Thickness;                                                  // 0x0588   (0x0004)  
	char                                               SegmentFlags;                                               // 0x058C   (0x0001)  
...
{ 
public:
	UGizmoLineHandleComponent*                         UpIntervalComponent;                                        // 0x0228   (0x0008)  
	UGizmoLineHandleComponent*                         DownIntervalComponent;                                      // 0x0230   (0x0008)  
	UGizmoLineHandleComponent*                         ForwardIntervalComponent;                                   // 0x0238   (0x0008)  
};
...
/// Size: 0x0080 (0x000228 - 0x0002A8)
class ATransformGizmoActor : public AGizmoActor
{ 
public:
	UPrimitiveComponent*                               TranslateX;                                                 // 0x0228   (0x0008)  
	UPrimitiveComponent*                               TranslateY;                                                 // 0x0230   (0x0008)  
	UPrimitiveComponent*                               TranslateZ;                                                 // 0x0238   (0x0008)  
	UPrimitiveComponent*                               TranslateYZ;                                                // 0x0240   (0x0008)  
	UPrimitiveComponent*                               TranslateXZ;                                                // 0x0248   (0x0008)  
	UPrimitiveComponent*                               TranslateXY;                                                // 0x0250   (0x0008)  
	UPrimitiveComponent*                               RotateX;                                                    // 0x0258   (0x0008)  
	UPrimitiveComponent*                               RotateY;                                                    // 0x0260   (0x0008)  
	UPrimitiveComponent*                               RotateZ;                                                    // 0x0268   (0x0008)  
	UPrimitiveComponent*                               UniformScale;                                               // 0x0270   (0x0008)  
	UPrimitiveComponent*                               AxisScaleX;                                                 // 0x0278   (0x0008)  
	UPrimitiveComponent*                               AxisScaleY;                                                 // 0x0280   (0x0008)  
	UPrimitiveComponent*                               AxisScaleZ;                                                 // 0x0288   (0x0008)  
	UPrimitiveComponent*                               PlaneScaleYZ;                                               // 0x0290   (0x0008)  
	UPrimitiveComponent*                               PlaneScaleXZ;                                               // 0x0298   (0x0008)  
	UPrimitiveComponent*                               PlaneScaleXY;                                               // 0x02A0   (0x0008)  
};
...
public:
	...
	TArray<UPrimitiveComponent*>                       ActiveComponents;                                           // 0x00E0   (0x0010)  
	TArray<UPrimitiveComponent*>                       NonuniformScaleComponents;                                  // 0x00F0   (0x0010)  
	TArray<UInteractiveGizmo*>                         ActiveGizmos;                                               // 0x0100   (0x0010)  
	unsigned char                                      UnknownData03_5[0x10];                                      // 0x0110   (0x0010)  MISSED
	UGizmoConstantFrameAxisSource*                     CameraAxisSource;                                           // 0x0120   (0x0008)  
	UGizmoComponentAxisSource*                         AxisXSource;                                                // 0x0128   (0x0008)  
	UGizmoComponentAxisSource*                         AxisYSource;                                                // 0x0130   (0x0008)  
	UGizmoComponentAxisSource*                         AxisZSource;                                                // 0x0138   (0x0008)  
	UGizmoComponentAxisSource*                         UnitAxisXSource;                                            // 0x0140   (0x0008)  
	UGizmoComponentAxisSource*                         UnitAxisYSource;                                            // 0x0148   (0x0008)  
	UGizmoComponentAxisSource*                         UnitAxisZSource;                                            // 0x0150   (0x0008)  
	UGizmoTransformChangeStateTarget*                  StateTarget;                                                // 0x0158   (0x0008)  
	UGizmoScaledTransformSource*                       ScaledTransformSource;                                      // 0x0160   (0x0008)  
