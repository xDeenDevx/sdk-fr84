...
struct UCrosshair_CarWeapon_Flame_New_C : UVehicleWeaponCrossHairWidget {
	...
	void OnOverloadChanged(bool InOverload); // Function Crosshair_CarWeapon_Flame_New.Crosshair_CarWeapon_Flame_New_C.OnOverloadChanged // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x2649560
	...
	void OnOverloadStateChanged(bool bEnter); // Function Crosshair_CarWeapon_Flame_New.Crosshair_CarWeapon_Flame_New_C.OnOverloadStateChanged // (Event|Protected|BlueprintEvent) // @ game+0x2649560
	void OnAnimationFinished(struct UWidgetAnimation* Animation); // Function Crosshair_CarWeapon_Flame_New.Crosshair_CarWeapon_Flame_New_C.OnAnimationFinished // (BlueprintCosmetic|Event|Protected|BlueprintEvent) // @ game+0x2649560
	void OnCrosshairInNormalState(); // Function Crosshair_CarWeapon_Flame_New.Crosshair_CarWeapon_Flame_New_C.OnCrosshairInNormalState // (Event|Protected|BlueprintEvent) // @ game+0x2649560
	void ExecuteUbergraph_Crosshair_CarWeapon_Flame_New(int32_t EntryPoint); // Function Crosshair_CarWeapon_Flame_New.Crosshair_CarWeapon_Flame_New_C.ExecuteUbergraph_Crosshair_CarWeapon_Flame_New // (Final|UbergraphFunction) // @ game+0x2649560
};
