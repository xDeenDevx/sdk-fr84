...
public:
	...
	void OnRep_SimulatedTasks();                                                                                             // [0x3f79b40] Final|Native|Public  
	// Function /Script/GameplayTasks.GameplayTasksComponent.K2_RunGameplayTask
	EGameplayTaskRunResult K2_RunGameplayTask(TScriptInterface<Class> TaskOwner, UGameplayTask* Task, char Priority, TArray<UClass*> AdditionalRequiredResources, TArray<UClass*> AdditionalClaimedResources); // [0x3f798f0] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	void ReadyForActivation();                                                                                               // [0x3f79b60] Final|Native|Public|BlueprintCallable 
	// Function /Script/GameplayTasks.GameplayTask.GenericGameplayTaskDelegate__DelegateSignature
	void GenericGameplayTaskDelegate__DelegateSignature();                                                                   // [0x2649560] MulticastDelegate|Public|Delegate 
	// Function /Script/GameplayTasks.GameplayTask.EndTask
	void EndTask();                                                                                                          // [0x3f79800] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	UGameplayTask_SpawnActor* SpawnActor(TScriptInterface<Class> TaskOwner, FVector SpawnLocation, FRotator SpawnRotation, UClass* Class, bool bSpawnOnlyOnAuthority); // [0x3f79b80] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
	// Function /Script/GameplayTasks.GameplayTask_SpawnActor.FinishSpawningActor
	void FinishSpawningActor(UObject* WorldContextObject, AActor* SpawnedActor);                                             // [0x3f79820] Native|Public|BlueprintCallable 
	// Function /Script/GameplayTasks.GameplayTask_SpawnActor.BeginSpawningActor
	bool BeginSpawningActor(UObject* WorldContextObject, AActor*& SpawnedActor);                                             // [0x3f793f0] Native|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	UGameplayTask_WaitDelay* TaskWaitDelay(TScriptInterface<Class> TaskOwner, float Time, char Priority);                    // [0x3f79d50] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/GameplayTasks.GameplayTask_WaitDelay.TaskDelayDelegate__DelegateSignature
	void TaskDelayDelegate__DelegateSignature();                                                                             // [0x2649560] MulticastDelegate|Public|Delegate 
};
