...
struct UMeshRectangleWidget : UMeshWidgetUWidget {
	...
	void SetInstanceNum(int32_t NewNum); // Function MeshWidget.MeshRectangleWidget.SetInstanceNum // (Final|Native|Public|BlueprintCallable) // @ game+0x15b05a0
	void ModifyInstanceNum(int32_t dNum); // Function MeshWidget.MeshRectangleWidget.ModifyInstanceNum // (Final|Native|Public|BlueprintCallable) // @ game+0x15b05a0
	void InitUnitTestProvider(); // Function MeshWidget.MeshRectangleWidget.InitUnitTestProvider // (Final|Native|Public|BlueprintCallable) // @ game+0x8f2720
};
