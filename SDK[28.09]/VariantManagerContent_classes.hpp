...
{
public:
	uint8                                        Pad_256[0x60];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_25F[0x6F];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_28D[0x18];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2AB[0x18];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	class FText                                  DisplayText;                                       // 0x28(0x18)(Deprecated, NativeAccessSpecifierPrivate)
	uint8                                        Pad_2CF[0x18];                                     // Fixing Size After Last Property  [ Dumper-7 ]
