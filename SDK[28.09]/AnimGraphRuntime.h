...
public:
	...
	void OnNotifyEndReceived(FName NotifyName, FBranchingPointNotifyPayload& BranchingPointNotifyPayload);                   // [0x3404860] Final|Native|Protected|HasOutParms 
	// Function /Script/AnimGraphRuntime.PlayMontageCallbackProxy.OnNotifyBeginReceived
	void OnNotifyBeginReceived(FName NotifyName, FBranchingPointNotifyPayload& BranchingPointNotifyPayload);                 // [0x3404770] Final|Native|Protected|HasOutParms 
	// Function /Script/AnimGraphRuntime.PlayMontageCallbackProxy.OnMontageEnded
	void OnMontageEnded(UAnimMontage* Montage, bool bInterrupted);                                                           // [0x34046a0] Final|Native|Protected 
	// Function /Script/AnimGraphRuntime.PlayMontageCallbackProxy.OnMontageBlendingOut
	void OnMontageBlendingOut(UAnimMontage* Montage, bool bInterrupted);                                                     // [0x34045d0] Final|Native|Protected 
	// Function /Script/AnimGraphRuntime.PlayMontageCallbackProxy.CreateProxyObjectForPlayMontage
	UPlayMontageCallbackProxy* CreateProxyObjectForPlayMontage(USkeletalMeshComponent* InSkeletalMeshComponent, UAnimMontage* MontageToPlay, float PlayRate, float StartingPosition, FName StartingSection); // [0x3402ef0] Final|Native|Static|Public|BlueprintCallable 
};
...
{ 
	...
	UBlendSpaceBase*                                   BlendSpace;                                                 // 0x0048   (0x0008)  
	unsigned char                                      UnknownData01_5[0x88];                                      // 0x0050   (0x0088)  MISSED
	UBlendSpaceBase*                                   PreviousBlendSpace;                                         // 0x00D8   (0x0008)  
};
...
{ 
	unsigned char                                      UnknownData00_2[0x60];                                      // 0x00E0   (0x0060)  MISSED
...
{ 
	...
	bool                                               bUseSphericalLimits;                                        // 0x0245:0 (0x0001)  
	bool                                               bUsePlanarLimit;                                            // 0x0245:1 (0x0001)  
	bool                                               bDoUpdate;                                                  // 0x0245:2 (0x0001)  
	bool                                               bDoEval;                                                    // 0x0245:3 (0x0001)  
	bool                                               bOverrideLinearDamping;                                     // 0x0245:4 (0x0001)  
	bool                                               bOverrideAngularBias;                                       // 0x0245:5 (0x0001)  
	bool                                               bOverrideAngularDamping;                                    // 0x0245:6 (0x0001)  
	bool                                               bEnableWind;                                                // 0x0245:7 (0x0001)  
	unsigned char                                      UnknownBit03 : 1;                                           // 0x0246:0 (0x0001)  MISSED
	bool                                               bUseGravityOverride;                                        // 0x0246:1 (0x0001)  
	bool                                               bLinearSpring;                                              // 0x0246:2 (0x0001)  
	bool                                               bAngularSpring;                                             // 0x0246:3 (0x0001)  
	bool                                               bChain;                                                     // 0x0246:4 (0x0001)  
	unsigned char                                      UnknownData04_4[0x9];                                       // 0x0247   (0x0009)  MISSED
...
{ 
	UPoseAsset*                                        PoseAsset;                                                  // 0x0030   (0x0008)  
...
{ 
	...
	UCurveFloat*                                       CustomCurve;                                                // 0x0090   (0x0008)  
};
...
{ 
	...
	bool                                               bOnlyDriveSelectedBones;                                    // 0x0126:0 (0x0001)  
...
{ 
	...
	TEnumAsByte<EBoneAxis>                             TwistAxis;                                                  // 0x000E   (0x0001)  
...
{ 
	...
	TEnumAsByte<ECollisionChannel>                     OverlapChannel;                                             // 0x01B8   (0x0001)  
	...
	bool                                               bEnableWorldGeometry;                                       // 0x01BC:0 (0x0001)  
	bool                                               bOverrideWorldGravity;                                      // 0x01BC:1 (0x0001)  
	bool                                               bTransferBoneVelocities;                                    // 0x01BC:2 (0x0001)  
	bool                                               bFreezeIncomingPoseOnStart;                                 // 0x01BC:3 (0x0001)  
	bool                                               bClampLinearTranslationLimitToRefPose;                      // 0x01BC:4 (0x0001)  
...
{ 
	...
	TEnumAsByte<ECollisionChannel>                     OverlapChannel;                                             // 0x0120   (0x0001)  
	ESimulationSpace                                   SimulationSpace;                                            // 0x0121   (0x0001)  
	bool                                               bForceDisableCollisionBetweenConstraintBodies;              // 0x0122   (0x0001)  
	bool                                               bEnableWorldGeometry;                                       // 0x0123:0 (0x0001)  
	bool                                               bOverrideWorldGravity;                                      // 0x0123:1 (0x0001)  
	bool                                               bTransferBoneVelocities;                                    // 0x0123:2 (0x0001)  
	bool                                               bFreezeIncomingPoseOnStart;                                 // 0x0123:3 (0x0001)  
	bool                                               bClampLinearTranslationLimitToRefPose;                      // 0x0123:4 (0x0001)  
...
{ 
	UAnimSequenceBase*                                 Sequence;                                                   // 0x0030   (0x0008)  
	float                                              ExplicitTime;                                               // 0x0038   (0x0004)  
	bool                                               bShouldLoop;                                                // 0x003C   (0x0001)  
	bool                                               bTeleportToExplicitTime;                                    // 0x003D   (0x0001)  
	TEnumAsByte<ESequenceEvalReinit>                   ReinitializationBehavior;                                   // 0x003E   (0x0001)  
