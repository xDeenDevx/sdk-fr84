...
public:
	...
	static class AAbility_VH_Tire_9A04_TurretA1_ExplosionDamage_man_C* GetDefaultObj();

	void ReceiveBeginPlay();
	void ReceiveTick(float DeltaSeconds);
	void ExecuteUbergraph_Ability_VH_Tire_9A04_TurretA1_ExplosionDamage_man(int32 EntryPoint, float K2Node_Event_DeltaSeconds);
};
