...
public:
	...
	uint8                                        Pad_E29[0xC];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1164[0xF];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	enum class EAREye                            Eye;                                               // 0x0(0x1)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_1165[0xF];                                     // Fixing Size After Last Property  [ Dumper-7 ]
