...
struct UBP_QuickSummon_FootDown_C_TryGetSummonHitResult_Params
{
public:
	...
	struct FHitResult                            CallFunc_CanSummonFootDown_OutHitResult;           // 0x9C(0x88)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	bool                                         CallFunc_CanSummonFootDown_ReturnValue;            // 0x124(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
