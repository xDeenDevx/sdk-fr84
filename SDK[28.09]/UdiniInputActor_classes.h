...
struct UUdiniDataPart : UObject {
	...
	struct TArray<struct FLinearColor> VertexColors; // 0x40(0x10)
	struct TArray<struct FLinearColor> VertexColorsCatche; // 0x50(0x10)
	struct TArray<struct FVector> VertexNormal; // 0x60(0x10)
...
struct UUdiniSplineComponent : USplineComponent {
