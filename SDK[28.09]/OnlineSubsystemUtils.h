...
/// Size: 0x00A0 (0x001B10 - 0x001BB0)
class UIpConnection : public UNetConnection
{ 
public:
	unsigned char                                      UnknownData00_2[0x50];                                      // 0x1B10   (0x0050)  MISSED
	float                                              SocketErrorDisconnectDelay;                                 // 0x1B60   (0x0004)  
	unsigned char                                      UnknownData01_6[0x4C];                                      // 0x1B64   (0x004C)  MISSED
};
...
{ 
public:
	bool                                               LogPortUnreach;                                             // 0x0758:0 (0x0001)  
	bool                                               AllowPlayerPortUnreach;                                     // 0x0758:1 (0x0001)  
	unsigned char                                      UnknownData00_4[0x3];                                       // 0x0759   (0x0003)  MISSED
	uint32_t                                           MaxPortCountToTry;                                          // 0x075C   (0x0004)  
	unsigned char                                      UnknownData01_5[0xC];                                       // 0x0760   (0x000C)  MISSED
	uint32_t                                           ServerDesiredSocketReceiveBufferBytes;                      // 0x076C   (0x0004)  
	uint32_t                                           ServerDesiredSocketSendBufferBytes;                         // 0x0770   (0x0004)  
	uint32_t                                           ClientDesiredSocketReceiveBufferBytes;                      // 0x0774   (0x0004)  
	uint32_t                                           ClientDesiredSocketSendBufferBytes;                         // 0x0778   (0x0004)  
	unsigned char                                      UnknownData02_5[0x4];                                       // 0x077C   (0x0004)  MISSED
	double                                             MaxSecondsInReceive;                                        // 0x0780   (0x0008)  
	int32_t                                            NbPacketsBetweenReceiveTimeTest;                            // 0x0788   (0x0004)  
	float                                              ResolutionConnectionTimeout;                                // 0x078C   (0x0004)  
	unsigned char                                      UnknownData03_6[0x38];                                      // 0x0790   (0x0038)  MISSED
};
...
public:
	...
	UAchievementQueryCallbackProxy* CacheAchievements(UObject* WorldContextObject, APlayerController* PlayerController);     // [0xa7fb10] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/OnlineSubsystemUtils.AchievementQueryCallbackProxy.CacheAchievementDescriptions
	UAchievementQueryCallbackProxy* CacheAchievementDescriptions(UObject* WorldContextObject, APlayerController* PlayerController); // [0xa7fa40] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	UAchievementWriteCallbackProxy* WriteAchievementProgress(UObject* WorldContextObject, APlayerController* PlayerController, FName AchievementName, float Progress, int32_t UserTag); // [0xa81c30] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	UConnectionCallbackProxy* ConnectToService(UObject* WorldContextObject, APlayerController* PlayerController);            // [0xa7fbe0] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	UCreateSessionCallbackProxy* CreateSession(UObject* WorldContextObject, APlayerController* PlayerController, int32_t PublicConnections, bool bUseLAN); // [0xa80410] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	UDestroySessionCallbackProxy* DestroySession(UObject* WorldContextObject, APlayerController* PlayerController);          // [0xa80560] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	UEndMatchCallbackProxy* EndMatch(UObject* WorldContextObject, APlayerController* PlayerController, TScriptInterface<Class> MatchActor, FString MatchID, TEnumAsByte<EMPMatchOutcome> LocalPlayerOutcome, TEnumAsByte<EMPMatchOutcome> OtherPlayersOutcome); // [0xa80630] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	UEndTurnCallbackProxy* EndTurn(UObject* WorldContextObject, APlayerController* PlayerController, FString MatchID, TScriptInterface<Class> TurnBasedMatchInterface); // [0xa80860] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	FString GetServerName(FBlueprintSessionResult& Result);                                                                  // [0xa819a0] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/OnlineSubsystemUtils.FindSessionsCallbackProxy.GetPingInMs
	int32_t GetPingInMs(FBlueprintSessionResult& Result);                                                                    // [0xa81750] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/OnlineSubsystemUtils.FindSessionsCallbackProxy.GetMaxPlayers
	int32_t GetMaxPlayers(FBlueprintSessionResult& Result);                                                                  // [0xa81500] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/OnlineSubsystemUtils.FindSessionsCallbackProxy.GetCurrentPlayers
	int32_t GetCurrentPlayers(FBlueprintSessionResult& Result);                                                              // [0xa812b0] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/OnlineSubsystemUtils.FindSessionsCallbackProxy.FindSessions
	UFindSessionsCallbackProxy* FindSessions(UObject* WorldContextObject, APlayerController* PlayerController, int32_t MaxResults, bool bUseLAN); // [0xa80a20] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	UFindTurnBasedMatchCallbackProxy* FindTurnBasedMatch(UObject* WorldContextObject, APlayerController* PlayerController, TScriptInterface<Class> MatchActor, int32_t MinPlayers, int32_t MaxPlayers, int32_t PlayerGroup, bool ShowExistingMatches); // [0xa80b70] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	UInAppPurchaseCallbackProxy* CreateProxyObjectForInAppPurchase(APlayerController* PlayerController, FInAppPurchaseProductRequest& ProductRequest); // [0xa7fda0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	UInAppPurchaseCallbackProxy2* CreateProxyObjectForInAppPurchaseUnprocessedPurchases(APlayerController* PlayerController); // [0xa80380] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/OnlineSubsystemUtils.InAppPurchaseCallbackProxy2.CreateProxyObjectForInAppPurchaseQueryOwned
	UInAppPurchaseCallbackProxy2* CreateProxyObjectForInAppPurchaseQueryOwned(APlayerController* PlayerController);          // [0xa800b0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/OnlineSubsystemUtils.InAppPurchaseCallbackProxy2.CreateProxyObjectForInAppPurchase
	UInAppPurchaseCallbackProxy2* CreateProxyObjectForInAppPurchase(APlayerController* PlayerController, FInAppPurchaseProductRequest2& ProductRequest); // [0xa7fcb0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	UInAppPurchaseQueryCallbackProxy* CreateProxyObjectForInAppPurchaseQuery(APlayerController* PlayerController, TArray<FString>& ProductIdentifiers); // [0xa7ffa0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	UInAppPurchaseQueryCallbackProxy2* CreateProxyObjectForInAppPurchaseQuery(APlayerController* PlayerController, TArray<FString>& ProductIdentifiers); // [0xa7fe90] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	UInAppPurchaseRestoreCallbackProxy* CreateProxyObjectForInAppPurchaseRestore(TArray<FInAppPurchaseProductRequest>& ConsumableProductFlags, APlayerController* PlayerController); // [0xa80260] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	UInAppPurchaseRestoreCallbackProxy2* CreateProxyObjectForInAppPurchaseRestore(TArray<FInAppPurchaseProductRequest2>& ConsumableProductFlags, APlayerController* PlayerController); // [0xa80140] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	UJoinSessionCallbackProxy* JoinSession(UObject* WorldContextObject, APlayerController* PlayerController, FBlueprintSessionResult& SearchResult); // [0xa85930] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	ULeaderboardFlushCallbackProxy* CreateProxyObjectForFlush(APlayerController* PlayerController, FName SessionName);       // [0xa85790] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	ULeaderboardQueryCallbackProxy* CreateProxyObjectForIntQuery(APlayerController* PlayerController, FName StatName);       // [0xa85860] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	ULogoutCallbackProxy* Logout(UObject* WorldContextObject, APlayerController* PlayerController);                          // [0xa85a80] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	UNetDriver*                                        NetDriver;                                                  // 0x0238   (0x0008)  
...
{ 
public:
	AOnlineBeaconHostObject*                           BeaconOwner;                                                // 0x0258   (0x0008)  
	UNetConnection*                                    BeaconConnection;                                           // 0x0260   (0x0008)  
	EBeaconConnectionState                             ConnectionState;                                            // 0x0268   (0x0001)  
	unsigned char                                      UnknownData00_6[0x4F];                                      // 0x0269   (0x004F)  MISSED


	/// Functions
	// Function /Script/OnlineSubsystemUtils.OnlineBeaconClient.ClientOnConnected
	void ClientOnConnected();                                                                                                // [0x7debc0] Final|Net|NetReliableNative|Event|Private|NetClient 
};
...
public:
	...
	TArray<AOnlineBeaconClient*>                       ClientActors;                                               // 0x0260   (0x0010)  
	unsigned char                                      UnknownData01_6[0xA0];                                      // 0x0270   (0x00A0)  MISSED
};
...
public:
	...
	UClass*                                            ClientBeaconActorClass;                                     // 0x0238   (0x0008)  
	TArray<AOnlineBeaconClient*>                       ClientActors;                                               // 0x0240   (0x0010)  
};
...
public:
	...
	unsigned char                                      UnknownData01_6[0x2D];                                      // 0x034B   (0x002D)  MISSED


	/// Functions
	// Function /Script/OnlineSubsystemUtils.PartyBeaconClient.ServerUpdateReservationRequest
	void ServerUpdateReservationRequest(FString SessionId, FPartyReservation ReservationUpdate);                             // [0xa865a0] Net|NetReliableNative|Event|Protected|NetServer|NetValidate 
	// Function /Script/OnlineSubsystemUtils.PartyBeaconClient.ServerReservationRequest
	void ServerReservationRequest(FString SessionId, FPartyReservation Reservation);                                         // [0xa86110] Net|NetReliableNative|Event|Protected|NetServer|NetValidate 
	// Function /Script/OnlineSubsystemUtils.PartyBeaconClient.ServerRemoveMemberFromReservationRequest
	void ServerRemoveMemberFromReservationRequest(FString SessionId, FPartyReservation ReservationUpdate);                   // [0xa85e80] Net|NetReliableNative|Event|Protected|NetServer|NetValidate 
	// Function /Script/OnlineSubsystemUtils.PartyBeaconClient.ServerCancelReservationRequest
	void ServerCancelReservationRequest(FUniqueNetIdRepl PartyLeader);                                                       // [0xa85d20] Net|NetReliableNative|Event|Protected|NetServer|NetValidate 
	// Function /Script/OnlineSubsystemUtils.PartyBeaconClient.ClientSendReservationUpdates
	void ClientSendReservationUpdates(int32_t NumRemainingReservations);                                                     // [0xa85670] Net|NetReliableNative|Event|Public|NetClient 
	// Function /Script/OnlineSubsystemUtils.PartyBeaconClient.ClientSendReservationFull
	void ClientSendReservationFull();                                                                                        // [0xa85650] Net|NetReliableNative|Event|Public|NetClient 
	// Function /Script/OnlineSubsystemUtils.PartyBeaconClient.ClientReservationResponse
	void ClientReservationResponse(TEnumAsByte<EPartyReservationResult> ReservationResponse);                                // [0xa85550] Net|NetReliableNative|Event|Public|NetClient 
	// Function /Script/OnlineSubsystemUtils.PartyBeaconClient.ClientCancelReservationResponse
	void ClientCancelReservationResponse(TEnumAsByte<EPartyReservationResult> ReservationResponse);                          // [0xa85430] Net|NetReliableNative|Event|Public|NetClient 
};

/// Class /Script/OnlineSubsystemUtils.PartyBeaconHost
/// Size: 0x0078 (0x000250 - 0x0002C8)
class APartyBeaconHost : public AOnlineBeaconHostObject
{ 
public:
	UPartyBeaconState*                                 State;                                                      // 0x0250   (0x0008)  
	unsigned char                                      UnknownData00_5[0x60];                                      // 0x0258   (0x0060)  MISSED
...
public:
	...
	UQuitMatchCallbackProxy* QuitMatch(UObject* WorldContextObject, APlayerController* PlayerController, FString MatchID, TEnumAsByte<EMPMatchOutcome> Outcome, int32_t TurnTimeoutInSeconds); // [0xa85b50] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	UShowLoginUICallbackProxy* ShowExternalLoginUI(UObject* WorldContextObject, APlayerController* InPlayerController);      // [0xa86830] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	unsigned char                                      UnknownData01_6[0x2D];                                      // 0x0373   (0x002D)  MISSED


	/// Functions
	// Function /Script/OnlineSubsystemUtils.SpectatorBeaconClient.ServerReservationRequest
	void ServerReservationRequest(FString SessionId, FSpectatorReservation Reservation);                                     // [0xa863a0] Net|NetReliableNative|Event|Protected|NetServer|NetValidate 
	// Function /Script/OnlineSubsystemUtils.SpectatorBeaconClient.ServerCancelReservationRequest
	void ServerCancelReservationRequest(FUniqueNetIdRepl Spectator);                                                         // [0xa85d20] Net|NetReliableNative|Event|Protected|NetServer|NetValidate 
	// Function /Script/OnlineSubsystemUtils.SpectatorBeaconClient.ClientSendReservationUpdates
	void ClientSendReservationUpdates(int32_t NumRemainingReservations);                                                     // [0xa85700] Net|NetReliableNative|Event|Public|NetClient 
	// Function /Script/OnlineSubsystemUtils.SpectatorBeaconClient.ClientSendReservationFull
	void ClientSendReservationFull();                                                                                        // [0x7e5fd0] Net|NetReliableNative|Event|Public|NetClient 
	// Function /Script/OnlineSubsystemUtils.SpectatorBeaconClient.ClientReservationResponse
	void ClientReservationResponse(TEnumAsByte<ESpectatorReservationResult> ReservationResponse);                            // [0xa855d0] Net|NetReliableNative|Event|Public|NetClient 
	// Function /Script/OnlineSubsystemUtils.SpectatorBeaconClient.ClientCancelReservationResponse
	void ClientCancelReservationResponse(TEnumAsByte<ESpectatorReservationResult> ReservationResponse);                      // [0xa854b0] Net|NetReliableNative|Event|Public|NetClient 
};
...
{ 
public:
	USpectatorBeaconState*                             State;                                                      // 0x0250   (0x0008)  
	unsigned char                                      UnknownData00_5[0x60];                                      // 0x0258   (0x0060)  MISSED
	bool                                               bLogoutOnSessionTimeout;                                    // 0x02B8   (0x0001)  
	unsigned char                                      UnknownData01_5[0x3];                                       // 0x02B9   (0x0003)  MISSED
	float                                              SessionTimeoutSecs;                                         // 0x02BC   (0x0004)  
...
{ 
public:
	unsigned char                                      UnknownData00_1[0x60];                                      // 0x07F0   (0x0060)  MISSED
};
