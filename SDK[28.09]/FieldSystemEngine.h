...
{ 
public:
	UFieldSystemComponent*                             FieldSystemComponent;                                       // 0x0228   (0x0008)  
};
...
{ 
public:
	UFieldSystem*                                      FieldSystem;                                                // 0x0540   (0x0008)  
	unsigned char                                      UnknownData00_5[0x10];                                      // 0x0548   (0x0010)  MISSED
	TArray<TWeakObjectPtr>                             SupportedSolvers;                                           // 0x0558   (0x0010)  
	unsigned char                                      UnknownData01_6[0x18];                                      // 0x0568   (0x0018)  MISSED


	/// Functions
	// Function /Script/FieldSystemEngine.FieldSystemComponent.ResetFieldSystem
	void ResetFieldSystem();                                                                                                 // [0x3f8fa80] Final|Native|Public|BlueprintCallable 
	// Function /Script/FieldSystemEngine.FieldSystemComponent.ApplyUniformVectorFalloffForce
	void ApplyUniformVectorFalloffForce(bool Enabled, FVector Position, FVector Direction, float Radius, float Magnitude);   // [0x3f8f8c0] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/FieldSystemEngine.FieldSystemComponent.ApplyStrainField
	void ApplyStrainField(bool Enabled, FVector Position, float Radius, float Magnitude, int32_t Iterations);                // [0x3f8f6f0] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/FieldSystemEngine.FieldSystemComponent.ApplyStayDynamicField
	void ApplyStayDynamicField(bool Enabled, FVector Position, float Radius);                                                // [0x3f8f5c0] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/FieldSystemEngine.FieldSystemComponent.ApplyRadialVectorFalloffForce
	void ApplyRadialVectorFalloffForce(bool Enabled, FVector Position, float Radius, float Magnitude);                       // [0x3f8f430] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/FieldSystemEngine.FieldSystemComponent.ApplyRadialForce
	void ApplyRadialForce(bool Enabled, FVector Position, float Magnitude);                                                  // [0x3f8f300] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/FieldSystemEngine.FieldSystemComponent.ApplyPhysicsField
	void ApplyPhysicsField(bool Enabled, TEnumAsByte<EFieldPhysicsType> Target, UFieldSystemMetaData* MetaData, UFieldNodeBase* Field); // [0x3f8f1a0] Final|Native|Public|BlueprintCallable 
	// Function /Script/FieldSystemEngine.FieldSystemComponent.ApplyLinearForce
	void ApplyLinearForce(bool Enabled, FVector Direction, float Magnitude);                                                 // [0x3f8f070] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/FieldSystemEngine.FieldSystemComponent.AddFieldCommand
	void AddFieldCommand(bool Enabled, TEnumAsByte<EFieldPhysicsType> Target, UFieldSystemMetaData* MetaData, UFieldNodeBase* Field); // [0x3f8ef10] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	UFieldSystemMetaDataIteration* SetMetaDataIteration(int32_t Iterations);                                                 // [0x3f8fe00] Final|Native|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	UFieldSystemMetaDataProcessingResolution* SetMetaDataaProcessingResolutionType(TEnumAsByte<EFieldResolutionType> ResolutionType); // [0x3f8fea0] Final|Native|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	UUniformInteger* SetUniformInteger(int32_t Magnitude);                                                                   // [0x3f8fe00] Final|Native|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	URadialIntMask* SetRadialIntMask(float Radius, FVector Position, int32_t InteriorValue, int32_t ExteriorValue, TEnumAsByte<ESetMaskConditionType> SetMaskConditionIn); // [0x3f90710] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	UUniformScalar* SetUniformScalar(float Magnitude);                                                                       // [0x3f909e0] Final|Native|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	URadialFalloff* SetRadialFalloff(float Magnitude, float MinRange, float MaxRange, float Default, float Radius, FVector Position, TEnumAsByte<EFieldFalloffType> Falloff); // [0x3f904c0] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	UPlaneFalloff* SetPlaneFalloff(float Magnitude, float MinRange, float MaxRange, float Default, float Distance, FVector Position, FVector Normal, TEnumAsByte<EFieldFalloffType> Falloff); // [0x3f90220] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	UBoxFalloff* SetBoxFalloff(float Magnitude, float MinRange, float MaxRange, float Default, FTransform Transform, TEnumAsByte<EFieldFalloffType> Falloff); // [0x3f8faa0] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	UNoiseField* SetNoiseField(float MinRange, float MaxRange, FTransform Transform);                                        // [0x3f8ff30] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	UUniformVector* SetUniformVector(float Magnitude, FVector Direction);                                                    // [0x3f908f0] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	URadialVector* SetRadialVector(float Magnitude, FVector Position);                                                       // [0x3f908f0] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	URandomVector* SetRandomVector(float Magnitude);                                                                         // [0x3f909e0] Final|Native|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	UOperatorField* SetOperatorField(float Magnitude, UFieldNodeBase* RightField, UFieldNodeBase* LeftField, TEnumAsByte<EFieldOperationType> Operation); // [0x3f900c0] Final|Native|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	UToIntegerField* SetToIntegerField(UFieldNodeFloat* FloatField);                                                         // [0x3f90a70] Final|Native|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	UToFloatField* SetToFloatField(UFieldNodeInt* IntegerField);                                                             // [0x3f90a70] Final|Native|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	UCullingField* SetCullingField(UFieldNodeBase* Culling, UFieldNodeBase* Field, TEnumAsByte<EFieldCullingOperationType> Operation); // [0x3f8fcf0] Final|Native|Public|BlueprintCallable|BlueprintPure 
};
