...
public:
	...
	uint8                                        Pad_1B0[0x9C];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_532[0x390];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<class UEditableMeshAdapter*>          Adapters;                                          // 0x3B8(0x10)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_533[0x8];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_534[0x148];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_53E[0x1E4];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_58E[0xA4];                                     // Fixing Size Of Struct [ Dumper-7 ]
