...
struct UUI_CursorWidget_Default_C : UUserWidget {
	...
	struct FString GetModuleName(); // Function UI_CursorWidget_Default.UI_CursorWidget_Default_C.GetModuleName // (Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|Const) // @ game+0x2649560
};
