...
{
public:
	uint8                                        Pad_FB7[0x1];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_FFE[0x1];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	enum class ELandscapeSplineSegmentSurface    Type;                                              // 0x0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	uint8                                        Pad_1007[0x1];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1025[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
