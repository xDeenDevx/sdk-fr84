...
public:
	...
	static class AAbility_VH_Tire_Mphy01_TurretB1_Rocket_ExplosionDamage_man_C* GetDefaultObj();

	void ReceiveBeginPlay();
	void ReceiveTick(float DeltaSeconds);
	void ExecuteUbergraph_Ability_VH_Tire_Mphy01_TurretB1_Rocket_ExplosionDamage_man(int32 EntryPoint, float K2Node_Event_DeltaSeconds);
};
