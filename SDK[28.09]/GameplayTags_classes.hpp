...
public:
	...
	uint8                                        Pad_E63[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_E6D[0x98];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<struct FGameplayTagSource>            TagSources;                                        // 0xC0(0x10)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_E6E[0xE0];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_EB4[0x5];                                      // Fixing Size After Last Property  [ Dumper-7 ]
