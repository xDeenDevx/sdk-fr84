...
{
public:
	uint8                                        Pad_DC2[0x8];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_DC5[0x110];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_DDD[0x2];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_DE3[0x18];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_DE7[0x8];                                      // Fixing Size After Last Property  [ Dumper-7 ]
