...
struct FCommonAnalogCursorSettings {
	...
	float CursorRadius; // 0x14(0x04)
	float HoverSlowdownFactor; // 0x18(0x04)
	float ScrollDeadZone; // 0x1c(0x04)
	float ScrollUpdatePeriod; // 0x20(0x04)
	float ScrollMultiplier; // 0x24(0x04)
};
...
struct FCommonInputTypeInfo {
	...
	struct FSlateBrush OverrideBrush; // 0x20(0x98)
};
