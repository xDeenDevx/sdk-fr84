...
public:
	...
	bool IsCapturing();                                                                                                      // [0x36a40b0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieSceneCapture.MovieSceneCaptureProtocolBase.GetState
	EMovieSceneCaptureProtocolState GetState();                                                                              // [0x3107560] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	void SetImageCaptureProtocolType(UClass* ProtocolType);                                                                  // [0x36a43a0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieSceneCapture.MovieSceneCapture.SetAudioCaptureProtocolType
	void SetAudioCaptureProtocolType(UClass* ProtocolType);                                                                  // [0x36a4310] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieSceneCapture.MovieSceneCapture.GetImageCaptureProtocol
	UMovieSceneCaptureProtocolBase* GetImageCaptureProtocol();                                                               // [0x36a4060] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieSceneCapture.MovieSceneCapture.GetAudioCaptureProtocol
	UMovieSceneCaptureProtocolBase* GetAudioCaptureProtocol();                                                               // [0x36a3fc0] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	void StopCapturingFinalPixels();                                                                                         // [0x36a45b0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieSceneCapture.UserDefinedCaptureProtocol.StartCapturingFinalPixels
	void StartCapturingFinalPixels(FCapturedPixelsID& StreamID);                                                             // [0x36a4430] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MovieSceneCapture.UserDefinedCaptureProtocol.ResolveBuffer
	void ResolveBuffer(UTexture* Buffer, FCapturedPixelsID& BufferID);                                                       // [0x36a4150] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MovieSceneCapture.UserDefinedCaptureProtocol.OnWarmUp
	void OnWarmUp();                                                                                                         // [0x2649560] Event|Protected|BlueprintEvent 
	// Function /Script/MovieSceneCapture.UserDefinedCaptureProtocol.OnTick
	void OnTick();                                                                                                           // [0x2649560] Event|Protected|BlueprintEvent 
	// Function /Script/MovieSceneCapture.UserDefinedCaptureProtocol.OnStartCapture
	void OnStartCapture();                                                                                                   // [0x2649560] Event|Protected|BlueprintEvent 
	// Function /Script/MovieSceneCapture.UserDefinedCaptureProtocol.OnSetup
	bool OnSetup();                                                                                                          // [0x36a4120] Native|Event|Protected|BlueprintEvent 
	// Function /Script/MovieSceneCapture.UserDefinedCaptureProtocol.OnPreTick
	void OnPreTick();                                                                                                        // [0x2649560] Event|Protected|BlueprintEvent 
	// Function /Script/MovieSceneCapture.UserDefinedCaptureProtocol.OnPixelsReceived
	void OnPixelsReceived(FCapturedPixels& Pixels, FCapturedPixelsID& ID, FFrameMetrics FrameMetrics);                       // [0x2649560] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/MovieSceneCapture.UserDefinedCaptureProtocol.OnPauseCapture
	void OnPauseCapture();                                                                                                   // [0x2649560] Event|Protected|BlueprintEvent 
	// Function /Script/MovieSceneCapture.UserDefinedCaptureProtocol.OnFinalize
	void OnFinalize();                                                                                                       // [0x2649560] Event|Protected|BlueprintEvent 
	// Function /Script/MovieSceneCapture.UserDefinedCaptureProtocol.OnCaptureFrame
	void OnCaptureFrame();                                                                                                   // [0x2649560] Event|Protected|BlueprintEvent 
	// Function /Script/MovieSceneCapture.UserDefinedCaptureProtocol.OnCanFinalize
	bool OnCanFinalize();                                                                                                    // [0x36a40f0] Native|Event|Protected|BlueprintEvent|Const 
	// Function /Script/MovieSceneCapture.UserDefinedCaptureProtocol.OnBeginFinalize
	void OnBeginFinalize();                                                                                                  // [0x2649560] Event|Protected|BlueprintEvent 
	// Function /Script/MovieSceneCapture.UserDefinedCaptureProtocol.GetCurrentFrameMetrics
	FFrameMetrics GetCurrentFrameMetrics();                                                                                  // [0x36a4040] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieSceneCapture.UserDefinedCaptureProtocol.GenerateFilename
	FString GenerateFilename(FFrameMetrics& InFrameMetrics);                                                                 // [0x36a3c40] Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	void WriteImageToDisk(FCapturedPixels& PixelData, FCapturedPixelsID& StreamID, FFrameMetrics& FrameMetrics, bool bCopyImageData); // [0x36a45d0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MovieSceneCapture.UserDefinedImageCaptureProtocol.GenerateFilenameForCurrentFrame
	FString GenerateFilenameForCurrentFrame();                                                                               // [0x36a3f40] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieSceneCapture.UserDefinedImageCaptureProtocol.GenerateFilenameForBuffer
	FString GenerateFilenameForBuffer(UTexture* Buffer, FCapturedPixelsID& StreamID);                                        // [0x36a3d30] Final|Native|Public|HasOutParms|BlueprintCallable 
};
