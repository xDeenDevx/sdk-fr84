...
{
public:
	uint8                                        Pad_11A6[0xA8];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_11A8[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_11A9[0x30];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
