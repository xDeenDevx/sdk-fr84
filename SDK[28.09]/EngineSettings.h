...
public:
	...
	void SetSkipAssigningGamepadToPlayer1(bool bSkipFirstPlayer);                                                            // [0x2e61eb0] Final|Native|Public|BlueprintCallable 
	// Function /Script/EngineSettings.GameMapsSettings.GetSkipAssigningGamepadToPlayer1
	bool GetSkipAssigningGamepadToPlayer1();                                                                                 // [0x2e61e80] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/EngineSettings.GameMapsSettings.GetGameMapsSettings
	UGameMapsSettings* GetGameMapsSettings();                                                                                // [0x2e61e50] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	bool                                               bStartInAR;                                                 // 0x010B   (0x0001)  
	bool                                               bSupportAR;                                                 // 0x010C   (0x0001)  
	bool                                               bAllowWindowResize;                                         // 0x010D   (0x0001)  
	bool                                               bAllowClose;                                                // 0x010E   (0x0001)  
	bool                                               bAllowMaximize;                                             // 0x010F   (0x0001)  
	bool                                               bAllowMinimize;                                             // 0x0110   (0x0001)  
	bool                                               bPCSession;                                                 // 0x0111   (0x0001)  
	bool                                               bSteamSession;                                              // 0x0112   (0x0001)  
	bool                                               bEpicSession;                                               // 0x0113   (0x0001)  
	bool                                               bOffcialWinSession;                                         // 0x0114   (0x0001)  
