...
{
public:
	uint8                                        Pad_136E[0xB8];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1373[0x30];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	bool                                         bLockRatio;                                        // 0x20(0x1)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_1379[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FVector2D                             Alignment;                                         // 0x24(0x8)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	struct FTextBlockStyle                       TextStyle;                                         // 0x8(0x2A8)(Edit, NativeAccessSpecifierPublic)
};
...
{
public:
	struct FSlateBrush                           Brush;                                             // 0x8(0x98)(Edit, NativeAccessSpecifierPublic)
};
...
{
public:
	uint8                                        Pad_138A[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
