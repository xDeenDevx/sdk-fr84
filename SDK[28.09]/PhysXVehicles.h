...
public:
	...
	void SetUseAutoGears(bool bUseAuto);                                                                                     // [0x4162bb0] Final|Native|Public|BlueprintCallable 
	// Function /Script/PhysXVehicles.WheeledVehicleMovementComponent.SetThrottleInput
	void SetThrottleInput(float Throttle);                                                                                   // [0x4162b30] Final|Native|Public|BlueprintCallable 
	// Function /Script/PhysXVehicles.WheeledVehicleMovementComponent.SetTargetGear
	void SetTargetGear(int32_t GearNum, bool bImmediate);                                                                    // [0x4162a60] Final|Native|Public|BlueprintCallable 
	// Function /Script/PhysXVehicles.WheeledVehicleMovementComponent.SetSteeringInput
	void SetSteeringInput(float Steering);                                                                                   // [0x41629e0] Final|Native|Public|BlueprintCallable 
	// Function /Script/PhysXVehicles.WheeledVehicleMovementComponent.SetHandbrakeInput
	void SetHandbrakeInput(bool bNewHandbrake);                                                                              // [0x4162880] Final|Native|Public|BlueprintCallable 
	// Function /Script/PhysXVehicles.WheeledVehicleMovementComponent.SetGroupsToIgnoreMask
	void SetGroupsToIgnoreMask(FNavAvoidanceMask& GroupMask);                                                                // [0x41627f0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/PhysXVehicles.WheeledVehicleMovementComponent.SetGroupsToIgnore
	void SetGroupsToIgnore(int32_t GroupFlags);                                                                              // [0x4162760] Final|Native|Public|BlueprintCallable 
	// Function /Script/PhysXVehicles.WheeledVehicleMovementComponent.SetGroupsToAvoidMask
	void SetGroupsToAvoidMask(FNavAvoidanceMask& GroupMask);                                                                 // [0x41626d0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/PhysXVehicles.WheeledVehicleMovementComponent.SetGroupsToAvoid
	void SetGroupsToAvoid(int32_t GroupFlags);                                                                               // [0x4162640] Final|Native|Public|BlueprintCallable 
	// Function /Script/PhysXVehicles.WheeledVehicleMovementComponent.SetGearUp
	void SetGearUp(bool bNewGearUp);                                                                                         // [0x41625b0] Final|Native|Public|BlueprintCallable 
	// Function /Script/PhysXVehicles.WheeledVehicleMovementComponent.SetGearDown
	void SetGearDown(bool bNewGearDown);                                                                                     // [0x4162520] Final|Native|Public|BlueprintCallable 
	// Function /Script/PhysXVehicles.WheeledVehicleMovementComponent.SetBrakeInput
	void SetBrakeInput(float Brake);                                                                                         // [0x4162300] Final|Native|Public|BlueprintCallable 
	// Function /Script/PhysXVehicles.WheeledVehicleMovementComponent.SetAvoidanceGroupMask
	void SetAvoidanceGroupMask(FNavAvoidanceMask& GroupMask);                                                                // [0x4162270] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/PhysXVehicles.WheeledVehicleMovementComponent.SetAvoidanceGroup
	void SetAvoidanceGroup(int32_t GroupFlags);                                                                              // [0x41621e0] Final|Native|Public|BlueprintCallable 
	// Function /Script/PhysXVehicles.WheeledVehicleMovementComponent.SetAvoidanceEnabled
	void SetAvoidanceEnabled(bool bEnable);                                                                                  // [0x4162150] Final|Native|Public|BlueprintCallable 
	// Function /Script/PhysXVehicles.WheeledVehicleMovementComponent.ServerUpdateState
	void ServerUpdateState(float InSteeringInput, float InThrottleInput, float InBrakeInput, float InHandbrakeInput, int32_t CurrentGear); // [0x4161f60] Net|NetReliableNative|Event|Protected|NetServer|NetValidate 
	// Function /Script/PhysXVehicles.WheeledVehicleMovementComponent.GetUseAutoGears
	bool GetUseAutoGears();                                                                                                  // [0x4161ed0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/PhysXVehicles.WheeledVehicleMovementComponent.GetTargetGear
	int32_t GetTargetGear();                                                                                                 // [0x4161ea0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/PhysXVehicles.WheeledVehicleMovementComponent.GetForwardSpeed
	float GetForwardSpeed();                                                                                                 // [0x4161de0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/PhysXVehicles.WheeledVehicleMovementComponent.GetEngineRotationSpeed
	float GetEngineRotationSpeed();                                                                                          // [0x4161db0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/PhysXVehicles.WheeledVehicleMovementComponent.GetEngineMaxRotationSpeed
	float GetEngineMaxRotationSpeed();                                                                                       // [0x4161d80] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/PhysXVehicles.WheeledVehicleMovementComponent.GetCurrentGear
	int32_t GetCurrentGear();                                                                                                // [0x4161d50] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
{ 
public:
	unsigned char                                      UnknownData00_2[0x700];                                     // 0x0270   (0x0700)  MISSED
	UWheeledVehicleMovementComponent*                  WheeledVehicleMovementComponent;                            // 0x0970   (0x0008)  
	unsigned char                                      UnknownData01_6[0x8];                                       // 0x0978   (0x0008)  MISSED


	/// Functions
	// Function /Script/PhysXVehicles.VehicleAnimInstance.GetVehicle
	AWheeledVehicle* GetVehicle();                                                                                           // [0x4161f00] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	bool IsInAir();                                                                                                          // [0x4161f30] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/PhysXVehicles.VehicleWheel.GetSuspensionOffset
	float GetSuspensionOffset();                                                                                             // [0x4161e70] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/PhysXVehicles.VehicleWheel.GetSteerAngle
	float GetSteerAngle();                                                                                                   // [0x4161e40] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/PhysXVehicles.VehicleWheel.GetRotationAngle
	float GetRotationAngle();                                                                                                // [0x4161e10] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	UWheeledVehicleMovementComponent*                  VehicleMovement;                                            // 0x0290   (0x0008)  
};
