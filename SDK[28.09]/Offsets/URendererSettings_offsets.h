namespace offsets
{
	namespace URendererSettings
	{
			...
			constexpr auto bMobileUseLegacyShadingModel = 0x44; // Size: 1, Type: char
			...
			constexpr auto bAnisotropicBRDF = 0x64; // Size: 1, Type: char
			...
			constexpr auto bGenerateLandscapeGIData = 0x6c; // Size: 1, Type: char
			...
			constexpr auto bSupportMaterialLayers = 0xe8; // Size: 1, Type: char
