namespace offsets
{
	namespace UNavigationSystemV1
	{
			...
			constexpr auto DataGatheringMode = 0x6c; // Size: 1, Type: enum class ENavDataGatheringModeConfig
			constexpr auto bGenerateNavigationOnlyAroundNavigationInvokers = 0x70; // Size: 1, Type: char
			constexpr auto ActiveTilesUpdateInterval = 0x74; // Size: 4, Type: float
			...
			constexpr auto OperationMode = 0x1cc; // Size: 1, Type: enum class FNavigationSystemRunMode
			constexpr auto DirtyAreasUpdateFreq = 0x524; // Size: 4, Type: float
	}
} 
