namespace offsets
{
	namespace UDatasmithImportOptions
	{
			...
			constexpr auto BaseOptions = 0x34; // Size: 20, Type: struct FDatasmithImportBaseOptions
			constexpr auto ReimportOptions = 0x48; // Size: 2, Type: struct FDatasmithReimportOptions
			constexpr auto Filename = 0x50; // Size: 16, Type: struct FString
			constexpr auto FilePath = 0x60; // Size: 16, Type: struct FString
	}
} 
