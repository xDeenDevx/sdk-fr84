...
struct FWidgetOverrideParam {
	...
	struct FGameplayTag GameplayTag; // 0xd8(0x08)
	struct TArray<struct FString> MetaData; // 0xe0(0x10)
};
...
struct FAutoDirectorActivityEventScoresInfo {
	...
	struct TArray<bool> PlayerMakeKilled; // 0x18(0x10)
};
...
struct FSolarTables_Tables {
	...
	struct FSolarTables_OBSubtitle_Action2Feature OBSubtitle_Action2Feature; // 0x1c28(0x60)
	struct FSolarTables_OBSubtitle_Feature2Emotion OBSubtitle_Feature2Emotion; // 0x1c88(0x60)
	struct FSolarTables_OBSubtitle_Emotion2Pattern OBSubtitle_Emotion2Pattern; // 0x1ce8(0x60)
	struct FSolarTables_Outcome Outcome; // 0x1d48(0x60)
	struct FSolarTables_OutcomeContent OutcomeContent; // 0x1da8(0x60)
	struct FSolarTables_PickupPriorityItem PickupPriorityItem; // 0x1e08(0x60)
	struct FSolarTables_PickupPriorityWeaponPart PickupPriorityWeaponPart; // 0x1e68(0x60)
	struct FSolarTables_CharacterVoiceover CharacterVoiceover; // 0x1ec8(0x60)
	struct FSolarTables_QuickChat QuickChat; // 0x1f28(0x60)
	struct FSolarTables_QuickVoice QuickVoice; // 0x1f88(0x60)
	struct FSolarTables_VODownload VODownload; // 0x1fe8(0x60)
	struct FSolarTables_RankLevel RankLevel; // 0x2048(0x60)
	struct FSolarTables_AutoDirector AutoDirector; // 0x20a8(0x60)
	struct FSolarTables_AutoDirectorActivityScore AutoDirectorActivityScore; // 0x2108(0x60)
	struct FSolarTables_CircularCameras CircularCameras; // 0x2168(0x60)
	struct FSolarTables_HotSpot HotSpot; // 0x21c8(0x60)
	struct FSolarTables_LookAtCameras LookAtCameras; // 0x2228(0x60)
	struct FSolarTables_Rescue Rescue; // 0x2288(0x60)
	struct FSolarTables_Skin Skin; // 0x22e8(0x60)
	struct FSolarTables_Achievement Achievement; // 0x2348(0x60)
	struct FSolarTables_TaskProgress TaskProgress; // 0x23a8(0x60)
	struct FSolarTables_TaskSystem TaskSystem; // 0x2408(0x60)
	struct FSolarTables_PlayerOperationListLayout PlayerOperationListLayout; // 0x2468(0x60)
	struct FSolarTables_Variables Variables; // 0x24c8(0x60)
	struct FSolarTables_Vehicle Vehicle; // 0x2528(0x60)
	struct FSolarTables_VehicleSkin VehicleSkin; // 0x2588(0x60)
	struct FSolarTables_VehicleType VehicleType; // 0x25e8(0x60)
	struct FSolarTables_VehicleSpawn VehicleSpawn; // 0x2648(0x60)
	struct FSolarTables_VehicleSpawnGroup VehicleSpawnGroup; // 0x26a8(0x60)
	struct FSolarTables_WarmGame WarmGame; // 0x2708(0x60)
	struct FSolarTables_WarmGameMode WarmGameMode; // 0x2768(0x60)
	struct FSolarTables_WeaponDamage WeaponDamage; // 0x27c8(0x60)
	struct FSolarTables_Weapon Weapon; // 0x2828(0x60)
	struct FSolarTables_WeaponAmmo WeaponAmmo; // 0x2888(0x60)
	struct FSolarTables_WeaponBattleUpgrade WeaponBattleUpgrade; // 0x28e8(0x60)
	struct FSolarTables_WeaponDefault WeaponDefault; // 0x2948(0x60)
	struct FSolarTables_WeaponKillTip WeaponKillTip; // 0x29a8(0x60)
	struct FSolarTables_WeaponParts WeaponParts; // 0x2a08(0x60)
	struct FSolarTables_WeaponPartsOp WeaponPartsOp; // 0x2a68(0x60)
	struct FSolarTables_WeaponQuality WeaponQuality; // 0x2ac8(0x60)
	struct FSolarTables_SecondMode SecondMode; // 0x2b28(0x60)
	struct FSolarTables_WeaponSkin WeaponSkin; // 0x2b88(0x60)
	struct FSolarTables_WeaponSound WeaponSound; // 0x2be8(0x60)
	struct FSolarTables_WeaponStatu WeaponStatu; // 0x2c48(0x60)
};
