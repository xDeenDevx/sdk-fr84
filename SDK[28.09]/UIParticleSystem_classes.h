...
struct UParticleSystemWidget : UWidget {
	...
	void SetReactivate(bool bActivateAndReset); // Function UIParticleSystem.ParticleSystemWidget.SetReactivate // (Final|Native|Public|BlueprintCallable) // @ game+0x81dca0
	void ActivateParticles(bool bActive, bool bReset); // Function UIParticleSystem.ParticleSystemWidget.ActivateParticles // (Final|Native|Public|BlueprintCallable) // @ game+0x81dbd0
};
