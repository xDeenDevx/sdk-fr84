...
struct UCrosshair_CarWeapon_Boat_C : UVehicleWeaponCrossHairWidget {
	...
	void OnUpdateChargeProgress(bool InbCharging, int32_t InChargeMode, float InChargeProgress, int32_t InChargeBurstCount); // Function Crosshair_CarWeapon_Boat.Crosshair_CarWeapon_Boat_C.OnUpdateChargeProgress // (Event|Protected|BlueprintEvent) // @ game+0x2649560
	void OnInitialized(); // Function Crosshair_CarWeapon_Boat.Crosshair_CarWeapon_Boat_C.OnInitialized // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x2649560
	void OnUpdateCoolDownProgress(float InCoolDownProgress); // Function Crosshair_CarWeapon_Boat.Crosshair_CarWeapon_Boat_C.OnUpdateCoolDownProgress // (Event|Protected|BlueprintEvent) // @ game+0x2649560
	void ExecuteUbergraph_Crosshair_CarWeapon_Boat(int32_t EntryPoint); // Function Crosshair_CarWeapon_Boat.Crosshair_CarWeapon_Boat_C.ExecuteUbergraph_Crosshair_CarWeapon_Boat // (Final|UbergraphFunction) // @ game+0x2649560
};
