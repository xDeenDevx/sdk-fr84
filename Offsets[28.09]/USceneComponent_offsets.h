namespace offsets
{
	namespace USceneComponent
	{
			...
			constexpr auto bDisableUpdateComponentToWorldIfNotVisiable = 0x14d; // Size: 1, Type: char
			constexpr auto bDisableUpdateComponentToWorldIfTickStateCoolingDown = 0x14d; // Size: 1, Type: char
			constexpr auto bDisableDeferredUpdateComponent = 0x14d; // Size: 1, Type: char
