namespace offsets
{
	namespace UMaterialExpressionCustom
	{
			...
			constexpr auto AdditionalDefines = 0x78; // Size: 16, Type: struct TArray<struct FCustomDefine>
			constexpr auto IncludeFilePaths = 0x88; // Size: 16, Type: struct TArray<struct FString>
	}
} 
