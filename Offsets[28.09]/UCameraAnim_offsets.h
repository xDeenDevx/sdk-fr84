namespace offsets
{
	namespace UCameraAnim
	{
			...
			constexpr auto BasePostProcessSettings = 0x60; // Size: 1440, Type: struct FPostProcessSettings
			constexpr auto BasePostProcessBlendWeight = 0x600; // Size: 4, Type: float
	}
} 
