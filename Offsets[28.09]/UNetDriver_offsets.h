namespace offsets
{
	namespace UNetDriver
	{
			...
			constexpr auto bNoTimeouts = 0x85; // Size: 1, Type: bool
			constexpr auto bNeverApplyNetworkEmulationSettings = 0x86; // Size: 1, Type: bool
			...
			constexpr auto ReplicationDriver = 0x6f8; // Size: 8, Type: struct UReplicationDriver*
	}
} 
