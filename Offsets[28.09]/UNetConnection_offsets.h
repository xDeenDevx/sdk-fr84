namespace offsets
{
	namespace UNetConnection
	{
			...
			constexpr auto PlayerId = 0x170; // Size: 40, Type: struct FUniqueNetIdRepl
			constexpr auto LastReceiveTime = 0x1f0; // Size: 8, Type: double
			constexpr auto ChannelsToTick = 0x1530; // Size: 16, Type: struct TArray<struct UChannel*>
	}
} 
