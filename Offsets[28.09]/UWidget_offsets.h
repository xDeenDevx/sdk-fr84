namespace offsets
{
	namespace UWidget
	{
			...
			constexpr auto DetailMode = 0xc8; // Size: 1, Type: enum class ESlateDetailMode
			constexpr auto bSelectedDetailModeOnly = 0xc9; // Size: 1, Type: bool
			constexpr auto WidthDivisor = 0xcc; // Size: 4, Type: int32_t
			constexpr auto HeightDivisor = 0xd0; // Size: 4, Type: int32_t
			constexpr auto Navigation = 0xd8; // Size: 8, Type: struct UWidgetNavigation*
			constexpr auto FlowDirectionPreference = 0xe0; // Size: 1, Type: enum class EFlowDirectionPreference
			constexpr auto NativeBindings = 0x128; // Size: 16, Type: struct TArray<struct UPropertyBinding*>
	}
} 
