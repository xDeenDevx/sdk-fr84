namespace offsets
{
	namespace UMaterial
	{
			...
			constexpr auto bAllowTwosidedFallback = 0x1c4; // Size: 1, Type: char
			constexpr auto DitheredLODTransition = 0x1c4; // Size: 1, Type: char
			constexpr auto DitherOpacityMask = 0x1c4; // Size: 1, Type: char
			constexpr auto bAllowNegativeEmissiveColor = 0x1c5; // Size: 1, Type: char
			constexpr auto TranslucencyLightingMode = 0x1c6; // Size: 1, Type: enum class ETranslucencyLightingMode
			constexpr auto bEnableMobileSeparateTranslucency = 0x1c7; // Size: 1, Type: char
			...
			constexpr auto bCanMaskedBeAssumedOpaque = 0x20a; // Size: 1, Type: char
			constexpr auto bIsMasked = 0x20a; // Size: 1, Type: char
			constexpr auto bIsPreviewMaterial = 0x20a; // Size: 1, Type: char
			constexpr auto bIsFunctionPreviewMaterial = 0x20a; // Size: 1, Type: char
			constexpr auto bZWrite = 0x20b; // Size: 1, Type: char
			constexpr auto DepthCompare = 0x20c; // Size: 1, Type: enum class EMaterialDepthCompare
			constexpr auto bMainPassStencilWrite = 0x20d; // Size: 1, Type: char
			constexpr auto bMainPassStencilCompareEnabled = 0x20d; // Size: 1, Type: char
			constexpr auto MainPassStencilCompare = 0x20e; // Size: 1, Type: enum class EMainPassMaterialStencilCompare
			constexpr auto MainPassStencilRefValue = 0x20f; // Size: 1, Type: char
			constexpr auto bUseMaterialAttributes = 0x210; // Size: 1, Type: char
			constexpr auto bCastRayTracedShadows = 0x210; // Size: 1, Type: char
			constexpr auto bUseTranslucencyVertexFog = 0x210; // Size: 1, Type: char
			constexpr auto bIsSky = 0x210; // Size: 1, Type: char
			constexpr auto bComputeFogPerPixel = 0x210; // Size: 1, Type: char
			constexpr auto bOutputTranslucentVelocity = 0x210; // Size: 1, Type: char
			constexpr auto bAllowDevelopmentShaderCompile = 0x210; // Size: 1, Type: char
			constexpr auto bIsMaterialEditorStatsMaterial = 0x210; // Size: 1, Type: char
			constexpr auto BlendableLocation = 0x211; // Size: 1, Type: enum class EBlendableLocation
			constexpr auto BlendableOutputAlpha = 0x212; // Size: 1, Type: char
			constexpr auto bEnableStencilTest = 0x212; // Size: 1, Type: char
			constexpr auto StencilCompare = 0x213; // Size: 1, Type: enum class EMaterialStencilCompare
			constexpr auto StencilRefValue = 0x214; // Size: 1, Type: char
			constexpr auto RefractionMode = 0x215; // Size: 1, Type: enum class ERefractionMode
			constexpr auto BlendablePriority = 0x218; // Size: 4, Type: int32_t
			constexpr auto bIsBlendable = 0x21c; // Size: 1, Type: char
			constexpr auto UsageFlagWarnings = 0x220; // Size: 4, Type: uint32_t
			constexpr auto RefractionDepthBias = 0x224; // Size: 4, Type: float
			constexpr auto StateId = 0x228; // Size: 16, Type: struct FGuid
			constexpr auto MaxDisplacement = 0x238; // Size: 4, Type: float
			constexpr auto CachedExpressionData = 0x2c8; // Size: 552, Type: struct FMaterialCachedExpressionData
	}
} 
