namespace offsets
{
	...
	{
			constexpr auto PS_CameraEffect = 0x278; // Size: 8, Type: struct UParticleSystem*
			constexpr auto PS_CameraEffectNonExtremeContent = 0x280; // Size: 8, Type: struct UParticleSystem*
			constexpr auto BaseCamera = 0x288; // Size: 8, Type: struct APlayerCameraManager*
