namespace offsets
{
	namespace ACharacter
	{
			...
			constexpr auto CharacterMovement = 0x290; // Size: 8, Type: struct UCharacterMovementComponent*
			constexpr auto CapsuleComponent = 0x298; // Size: 8, Type: struct UCapsuleComponent*
			constexpr auto BasedMovement = 0x2a0; // Size: 48, Type: struct FBasedMovementInfo
			constexpr auto ReplicatedBasedMovement = 0x2d0; // Size: 48, Type: struct FBasedMovementInfo
			constexpr auto AnimRootMotionTranslationScale = 0x300; // Size: 4, Type: float
			constexpr auto BaseTranslationOffset = 0x304; // Size: 12, Type: struct FVector
			...
			constexpr auto OnReachedJumpApex = 0x350; // Size: 16, Type: struct FMulticastInlineDelegate
			constexpr auto MovementModeChangedDelegate = 0x370; // Size: 16, Type: struct FMulticastInlineDelegate
			constexpr auto OnCharacterMovementUpdated = 0x380; // Size: 16, Type: struct FMulticastInlineDelegate
			constexpr auto SavedRootMotion = 0x390; // Size: 56, Type: struct FRootMotionSourceGroup
