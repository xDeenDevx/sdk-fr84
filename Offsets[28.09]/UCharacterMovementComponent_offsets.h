namespace offsets
{
	namespace UCharacterMovementComponent
	{
			...
			constexpr auto bNetworkEnableProxyPrediction = 0x1f2; // Size: 1, Type: char
			...
			constexpr auto bPushForceUsingZOffset = 0x1f3; // Size: 1, Type: char
			...
			constexpr auto NetworkLinearSmoothingLerpLimit = 0x2d8; // Size: 4, Type: float
			constexpr auto NetworkMinTimeBetweenClientAckGoodMoves = 0x2dc; // Size: 4, Type: float
			constexpr auto NetworkMinTimeBetweenClientAdjustments = 0x2e0; // Size: 4, Type: float
			constexpr auto NetworkMinTimeBetweenClientAdjustmentsLargeCorrection = 0x2e4; // Size: 4, Type: float
			constexpr auto NetworkLargeClientCorrectionDistance = 0x2e8; // Size: 4, Type: float
			constexpr auto LedgeCheckThreshold = 0x2ec; // Size: 4, Type: float
			constexpr auto JumpOutOfWaterPitch = 0x2f0; // Size: 4, Type: float
			constexpr auto CurrentFloor = 0x2f4; // Size: 148, Type: struct FFindFloorResult
			...
			constexpr auto CurrentRootMotion = 0x4d8; // Size: 56, Type: struct FRootMotionSourceGroup
			constexpr auto RootMotionParams = 0x5a0; // Size: 64, Type: struct FRootMotionMovementParams
			constexpr auto AnimRootMotionVelocity = 0x5e0; // Size: 12, Type: struct FVector
			constexpr auto bCanAdjustWalkingVelocityOnSliding = 0x610; // Size: 1, Type: bool
			constexpr auto bCanAdjustFallingVelocityOnSliding = 0x611; // Size: 1, Type: bool
			constexpr auto LimitedNewVelocityZOnTwoWallAdjust = 0x614; // Size: 4, Type: float
	}
} 
