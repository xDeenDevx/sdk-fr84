namespace offsets
{
	namespace ULevel
	{
			...
			constexpr auto LevelSolarDecorationLightMapGUIDs = 0x1e8; // Size: 80, Type: struct TMap<struct FName, struct FLevelSolarDecorationLightMapGUIDArray>
			constexpr auto LightBuildLevelOffset = 0x238; // Size: 12, Type: struct FIntVector
			constexpr auto bIsLightingScenario = 0x244; // Size: 1, Type: char
			constexpr auto bTextureStreamingRotationChanged = 0x244; // Size: 1, Type: char
			constexpr auto bStaticComponentsRegisteredInStreamingManager = 0x244; // Size: 1, Type: char
			constexpr auto bIsVisible = 0x244; // Size: 1, Type: char
			constexpr auto WorldSettings = 0x298; // Size: 8, Type: struct AWorldSettings*
			constexpr auto AssetUserData = 0x2a8; // Size: 16, Type: struct TArray<struct UAssetUserData*>
			constexpr auto DestroyedReplicatedStaticActors = 0x2c8; // Size: 16, Type: struct TArray<struct FReplicatedStaticActorDestructionInfo>
	}
} 
