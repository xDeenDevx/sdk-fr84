...
struct FSynth2DSliderStyle : FSlateWidgetStyle {
	...
	struct FSlateBrush NormalThumbImage; // 0x10(0xe0)
	struct FSlateBrush DisabledThumbImage; // 0xf0(0xe0)
	struct FSlateBrush NormalBarImage; // 0x1d0(0xe0)
	struct FSlateBrush DisabledBarImage; // 0x2b0(0xe0)
	struct FSlateBrush BackgroundImage; // 0x390(0xe0)
	float BarThickness; // 0x470(0x04)
...
struct FSynthKnobStyle : FSlateWidgetStyle {
	char pad_8[0x8]; // 0x08(0x08)
	struct FSlateBrush LargeKnob; // 0x10(0xe0)
	struct FSlateBrush LargeKnobOverlay; // 0xf0(0xe0)
	struct FSlateBrush MediumKnob; // 0x1d0(0xe0)
	struct FSlateBrush MediumKnobOverlay; // 0x2b0(0xe0)
	float MinValueAngle; // 0x390(0x04)
	float MaxValueAngle; // 0x394(0x04)
	enum class ESynthKnobSize KnobSize; // 0x398(0x01)
