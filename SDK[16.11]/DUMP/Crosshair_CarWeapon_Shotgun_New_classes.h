...
struct UCrosshair_CarWeapon_Shotgun_New_C : UVehicleWeaponCrossHairWidget {
	...
	void ChangeAmmoCount(int32_t ReloadCount, int32_t AmmoCount); // Function Crosshair_CarWeapon_Shotgun_New.Crosshair_CarWeapon_Shotgun_New_C.ChangeAmmoCount // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x2d656b0
	...
	void Construct(); // Function Crosshair_CarWeapon_Shotgun_New.Crosshair_CarWeapon_Shotgun_New_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x2d656b0
	void OnAmmoChanged(int32_t InReservedAmmo, int32_t InMaxAmmo, bool InbFirst); // Function Crosshair_CarWeapon_Shotgun_New.Crosshair_CarWeapon_Shotgun_New_C.OnAmmoChanged // (Event|Protected|BlueprintEvent) // @ game+0x2d656b0
	void OnReloadStarted(float InReloadTime, int32_t InReservedAmmo); // Function Crosshair_CarWeapon_Shotgun_New.Crosshair_CarWeapon_Shotgun_New_C.OnReloadStarted // (Event|Protected|BlueprintEvent) // @ game+0x2d656b0
	void OnReloadFinished(bool InbReloadSuccess, int32_t InReloadAmmo, int32_t InReservedAmmo, int32_t InMaxAmmo); // Function Crosshair_CarWeapon_Shotgun_New.Crosshair_CarWeapon_Shotgun_New_C.OnReloadFinished // (Event|Protected|BlueprintEvent) // @ game+0x2d656b0
	void ExecuteUbergraph_Crosshair_CarWeapon_Shotgun_New(int32_t EntryPoint); // Function Crosshair_CarWeapon_Shotgun_New.Crosshair_CarWeapon_Shotgun_New_C.ExecuteUbergraph_Crosshair_CarWeapon_Shotgun_New // (Final|UbergraphFunction) // @ game+0x2d656b0
};
