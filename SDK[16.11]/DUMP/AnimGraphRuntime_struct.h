...
struct FAnimNode_AnimDynamics : FAnimNode_SkeletalControlBase {
	...
	bool bForceResetTeleportType; // 0x244(0x01)
	char bUseSphericalLimits : 1; // 0x245(0x01)
	char bUsePlanarLimit : 1; // 0x245(0x01)
	char bDoUpdate : 1; // 0x245(0x01)
	char bDoEval : 1; // 0x245(0x01)
	char bOverrideLinearDamping : 1; // 0x245(0x01)
	char bOverrideAngularBias : 1; // 0x245(0x01)
	char bOverrideAngularDamping : 1; // 0x245(0x01)
	char bEnableWind : 1; // 0x245(0x01)
	char pad_246_0 : 1; // 0x246(0x01)
	char bUseGravityOverride : 1; // 0x246(0x01)
	char bLinearSpring : 1; // 0x246(0x01)
	char bAngularSpring : 1; // 0x246(0x01)
	char bChain : 1; // 0x246(0x01)
	char pad_246_5 : 3; // 0x246(0x01)
	char pad_247[0x9]; // 0x247(0x09)
...
struct FAnimNode_TwoWayBlend : FAnimNode_Base {
	...
	struct FName AlphaCurveName; // 0x88(0x08)
	struct FInputScaleBiasClamp AlphaScaleBiasClamp; // 0x90(0x30)
	int32_t LODThreshold; // 0xc0(0x04)
