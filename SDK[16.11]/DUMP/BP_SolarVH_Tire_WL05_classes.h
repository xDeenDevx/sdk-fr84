...
struct ABP_SolarVH_Tire_WL05_C : ABP_WheeledVehicleBase_C {
	...
	void ReceiveTick(float DeltaSeconds); // Function BP_SolarVH_Tire_WL05.BP_SolarVH_Tire_WL05_C.ReceiveTick // (Event|Public|BlueprintEvent) // @ game+0x2d656b0
	void ExecuteUbergraph_BP_SolarVH_Tire_WL05(int32_t EntryPoint); // Function BP_SolarVH_Tire_WL05.BP_SolarVH_Tire_WL05_C.ExecuteUbergraph_BP_SolarVH_Tire_WL05 // (Final|UbergraphFunction|HasDefaults) // @ game+0x2d656b0
};
