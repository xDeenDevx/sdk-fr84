...
struct FPlayerSelection {
	...
	struct UHeroPickCharacterData* SelectionData; // 0x08(0x08)
...
struct FAlertConfig {
	...
	struct FGameplayTagContainer BlockTags; // 0x90(0x20)
};
...
struct FGraphicsUserSettings {
	...
	char pad_E[0x2]; // 0x0e(0x02)
	struct FFloatValue CustomizedCharacterCameraFOV; // 0x10(0x04)
	int32_t SavedVersion; // 0x14(0x04)
...
struct FGraphicsUserSettingsPC {
	...
	enum class ESolarVSyncLevel VSync; // 0x1b(0x01)
...
struct FSolarTablesData_KillNotify : FSolarTablesDataBase {
	...
	struct FString Param; // 0xb0(0x10)
};
...
struct FSolarTables_Tables {
	...
	struct FSolarTables_HotSpot HotSpot; // 0x2348(0x60)
	struct FSolarTables_LookAtCameras LookAtCameras; // 0x23a8(0x60)
	struct FSolarTables_Rescue Rescue; // 0x2408(0x60)
	struct FSolarTables_Skin Skin; // 0x2468(0x60)
	struct FSolarTables_Achievement Achievement; // 0x24c8(0x60)
	struct FSolarTables_TaskProgress TaskProgress; // 0x2528(0x60)
	struct FSolarTables_TaskSystem TaskSystem; // 0x2588(0x60)
	struct FSolarTables_PlayerOperationListLayout PlayerOperationListLayout; // 0x25e8(0x60)
	struct FSolarTables_Variables Variables; // 0x2648(0x60)
	struct FSolarTables_Vehicle Vehicle; // 0x26a8(0x60)
	struct FSolarTables_VehicleSkin VehicleSkin; // 0x2708(0x60)
	struct FSolarTables_VehicleType VehicleType; // 0x2768(0x60)
	struct FSolarTables_VehicleSpawn VehicleSpawn; // 0x27c8(0x60)
	struct FSolarTables_VehicleSpawnGroup VehicleSpawnGroup; // 0x2828(0x60)
	struct FSolarTables_WarmGame WarmGame; // 0x2888(0x60)
	struct FSolarTables_WarmGameMode WarmGameMode; // 0x28e8(0x60)
	struct FSolarTables_WeaponDamage WeaponDamage; // 0x2948(0x60)
	struct FSolarTables_Weapon Weapon; // 0x29a8(0x60)
	struct FSolarTables_WeaponAmmo WeaponAmmo; // 0x2a08(0x60)
	struct FSolarTables_WeaponBattleUpgrade WeaponBattleUpgrade; // 0x2a68(0x60)
	struct FSolarTables_WeaponDefault WeaponDefault; // 0x2ac8(0x60)
	struct FSolarTables_WeaponKillTip WeaponKillTip; // 0x2b28(0x60)
	struct FSolarTables_WeaponParts WeaponParts; // 0x2b88(0x60)
	struct FSolarTables_WeaponPartsOp WeaponPartsOp; // 0x2be8(0x60)
	struct FSolarTables_WeaponQuality WeaponQuality; // 0x2c48(0x60)
	struct FSolarTables_SecondMode SecondMode; // 0x2ca8(0x60)
	struct FSolarTables_WeaponSkin WeaponSkin; // 0x2d08(0x60)
	struct FSolarTables_WeaponSound WeaponSound; // 0x2d68(0x60)
	struct FSolarTables_WeaponStatu WeaponStatu; // 0x2dc8(0x60)
};
