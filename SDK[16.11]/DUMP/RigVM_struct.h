...
struct FRigVMInstruction {
	enum class ERigVMOpCode OpCode; // 0x00(0x01)
	char pad_1[0x7]; // 0x01(0x07)
	uint64_t ByteCodeIndex; // 0x08(0x08)
};
...
struct FRigVMRegisterOffset {
	...
	struct UScriptStruct* ScriptStruct; // 0x20(0x08)
	struct FName ScriptStructPath; // 0x28(0x08)
	uint16_t ElementSize; // 0x30(0x02)
...
struct FRigVMRegister {
	...
	uint16_t SliceIndex; // 0x0c(0x02)
	uint16_t SliceCount; // 0x0e(0x02)
	char AlignmentBytes; // 0x10(0x01)
	char pad_11[0x1]; // 0x11(0x01)
	uint16_t TrailingBytes; // 0x12(0x02)
