...
struct UUI_Root_C : USolarUIRoot {
	...
	void Construct(); // Function UI_Root.UI_Root_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0xb6a060
	void OnInitialized(); // Function UI_Root.UI_Root_C.OnInitialized // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0xb6a060
	struct FString GetModuleName(); // Function UI_Root.UI_Root_C.GetModuleName // (Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|Const) // @ game+0x2d656b0
	void PreConstruct(bool IsDesignTime); // Function UI_Root.UI_Root_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x2d656b0
	void CustomEvent_1(struct UObject* Publisher, struct UObject* Payload, struct TArray<struct FString>& MetaData); // Function UI_Root.UI_Root_C.CustomEvent_1 // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x2d656b0
	void ExecuteUbergraph_UI_Root(int32_t EntryPoint); // Function UI_Root.UI_Root_C.ExecuteUbergraph_UI_Root // (Final|UbergraphFunction|HasDefaults) // @ game+0x2d656b0
};
