...
struct URawInputFunctionLibrary : UBlueprintFunctionLibrary {
	...
	struct TArray<struct FRegisteredDeviceInfo> GetRegisteredDevices(); // Function RawInput.RawInputFunctionLibrary.GetRegisteredDevices // (Final|Native|Static|Public|BlueprintCallable|BlueprintPure) // @ game+0xbfdf80
};
