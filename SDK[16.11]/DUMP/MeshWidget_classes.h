...
struct UMeshRectangleWidget : UMeshWidgetUWidget {
	...
	void SetInstanceNum(int32_t NewNum); // Function MeshWidget.MeshRectangleWidget.SetInstanceNum // (Final|Native|Public|BlueprintCallable) // @ game+0x1b49730
	void ModifyInstanceNum(int32_t dNum); // Function MeshWidget.MeshRectangleWidget.ModifyInstanceNum // (Final|Native|Public|BlueprintCallable) // @ game+0x1b49730
	void InitUnitTestProvider(); // Function MeshWidget.MeshRectangleWidget.InitUnitTestProvider // (Final|Native|Public|BlueprintCallable) // @ game+0x906ee0
};
