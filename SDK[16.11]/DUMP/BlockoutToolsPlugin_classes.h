...
struct ABlockoutToolsParent : AActor {
	...
	void RerunConstructionScript(); // Function BlockoutToolsPlugin.BlockoutToolsParent.RerunConstructionScript // (Final|Native|Private|BlueprintCallable) // @ game+0x82a8c0
	void BlockoutSetMaterial(); // Function BlockoutToolsPlugin.BlockoutToolsParent.BlockoutSetMaterial // (Final|Native|Private|BlueprintCallable) // @ game+0x82a8a0
};
