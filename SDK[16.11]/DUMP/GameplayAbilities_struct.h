...
struct FGameplayTagRequirements {
	enum class ETagRequirementCheckRule RequireTagCheckRule; // 0x00(0x01)
	char pad_1[0x7]; // 0x01(0x07)
	struct FGameplayTagContainer RequireTags; // 0x08(0x20)
	enum class ETagRequirementCheckRule IgnoreTagCheckRule; // 0x28(0x01)
	char pad_29[0x7]; // 0x29(0x07)
