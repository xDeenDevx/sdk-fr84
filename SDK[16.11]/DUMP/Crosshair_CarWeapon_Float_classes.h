...
struct UCrosshair_CarWeapon_Float_C : UVehicleWeaponCrossHairWidget {
	...
	void OnOverloadChanged(bool InOverload); // Function Crosshair_CarWeapon_Float.Crosshair_CarWeapon_Float_C.OnOverloadChanged // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x2d656b0
	void Set Charge Panel Size(); // Function Crosshair_CarWeapon_Float.Crosshair_CarWeapon_Float_C.Set Charge Panel Size // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x2d656b0
	void SetChargeProgress(); // Function Crosshair_CarWeapon_Float.Crosshair_CarWeapon_Float_C.SetChargeProgress // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x2d656b0
	...
	void Construct(); // Function Crosshair_CarWeapon_Float.Crosshair_CarWeapon_Float_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x2d656b0
	void OnUpdateChargeProgress(bool InbCharging, int32_t InChargeMode, float InChargeProgress, int32_t InChargeBurstCount); // Function Crosshair_CarWeapon_Float.Crosshair_CarWeapon_Float_C.OnUpdateChargeProgress // (Event|Protected|BlueprintEvent) // @ game+0x2d656b0
	void OnOverloadStateChanged(bool bEnter); // Function Crosshair_CarWeapon_Float.Crosshair_CarWeapon_Float_C.OnOverloadStateChanged // (Event|Protected|BlueprintEvent) // @ game+0x2d656b0
	void OnCrosshairInNormalState(); // Function Crosshair_CarWeapon_Float.Crosshair_CarWeapon_Float_C.OnCrosshairInNormalState // (Event|Protected|BlueprintEvent) // @ game+0x2d656b0
	void OnAnimationFinished(struct UWidgetAnimation* Animation); // Function Crosshair_CarWeapon_Float.Crosshair_CarWeapon_Float_C.OnAnimationFinished // (BlueprintCosmetic|Event|Protected|BlueprintEvent) // @ game+0x2d656b0
	void OnUpdateAimState(bool InbLockEnemy); // Function Crosshair_CarWeapon_Float.Crosshair_CarWeapon_Float_C.OnUpdateAimState // (Event|Protected|BlueprintEvent) // @ game+0x2d656b0
	void ExecuteUbergraph_Crosshair_CarWeapon_Float(int32_t EntryPoint); // Function Crosshair_CarWeapon_Float.Crosshair_CarWeapon_Float_C.ExecuteUbergraph_Crosshair_CarWeapon_Float // (Final|UbergraphFunction) // @ game+0x2d656b0
};
