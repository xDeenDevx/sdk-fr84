...
struct UCrosshair_CarWeapon_AssaultRifle_C : UVehicleWeaponCrossHairWidget {
	...
	struct UUserWidget* GetAmmoWidget(); // Function Crosshair_CarWeapon_AssaultRifle.Crosshair_CarWeapon_AssaultRifle_C.GetAmmoWidget // (Event|Protected|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x2d656b0
	struct UUserWidget* GetReloadWidget(); // Function Crosshair_CarWeapon_AssaultRifle.Crosshair_CarWeapon_AssaultRifle_C.GetReloadWidget // (Event|Protected|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x2d656b0
