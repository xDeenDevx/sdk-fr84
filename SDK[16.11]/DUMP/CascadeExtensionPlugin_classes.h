...
struct UForcePointDataProvider : UInterface {
	...
	struct FForcePoints GetForcePoints(); // Function CascadeExtensionPlugin.ForcePointDataProvider.GetForcePoints // (Native|Event|Public|BlueprintEvent|Const) // @ game+0xcc86e0
};
...
struct UMeshDataProvider : UInterface {
	...
	struct FMeshTriangleData GetMeshTriangleData(); // Function CascadeExtensionPlugin.MeshDataProvider.GetMeshTriangleData // (Native|Event|Public|BlueprintEvent|Const) // @ game+0xcc8e90
	int32_t GetDataRevision(); // Function CascadeExtensionPlugin.MeshDataProvider.GetDataRevision // (Native|Event|Public|BlueprintEvent|Const) // @ game+0xcc8e60
};
...
struct UParticleDataProvider : UInterface {
	...
	struct FParticleProperties UpdateParticle(struct FParticleProperties currentParticleProperties); // Function CascadeExtensionPlugin.ParticleDataProvider.UpdateParticle // (Native|Event|Public|BlueprintEvent|Const) // @ game+0xcc95c0
	struct FParticleProperties SpawnParticle(struct FParticleProperties currentParticleProperties); // Function CascadeExtensionPlugin.ParticleDataProvider.SpawnParticle // (Native|Event|Public|BlueprintEvent|Const) // @ game+0xcc94c0
};
...
struct UParticleDecalComponent : UDecalComponent {
	int32_t ModuleID; // 0x358(0x04)
	float TimeLeftUntilDestruction; // 0x35c(0x04)
	struct FVector BaseScale; // 0x360(0x0c)
};
...
struct UParticleModuleLocationMesh : UAbstractParticleModule {
	...
	void OnCachedActorDestroyed(struct AActor* DestroyedActor); // Function CascadeExtensionPlugin.ParticleModuleLocationMesh.OnCachedActorDestroyed // (Final|Native|Private) // @ game+0xcca5b0
};
