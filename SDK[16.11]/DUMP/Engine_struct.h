...
struct FPostProcessSettings {
	...
	char bOverride_PCBloomIntensity : 1; // 0x01(0x01)
	char bOverride_PCBloomThreshold : 1; // 0x01(0x01)
	...
	char bOverride_ColorGain : 1; // 0x02(0x01)
	char bOverride_ColorOffset : 1; // 0x02(0x01)
	...
	char bOverride_ColorContrastMidtones : 1; // 0x03(0x01)
	char bOverride_ColorGammaMidtones : 1; // 0x03(0x01)
	...
	char bOverride_ColorOffsetHighlights : 1; // 0x04(0x01)
	char bOverride_ColorCorrectionShadowsMax : 1; // 0x04(0x01)
	...
	char bOverride_FilmChannelMixerGreen : 1; // 0x05(0x01)
	char bOverride_FilmChannelMixerBlue : 1; // 0x05(0x01)
	...
	char bOverride_FilmShadowTintAmount : 1; // 0x06(0x01)
	char bOverride_FilmSlope : 1; // 0x06(0x01)
	...
	char bOverride_ChromaticAberrationStartOffset : 1; // 0x07(0x01)
	char bOverride_AmbientCubemapTint : 1; // 0x07(0x01)
	...
	char bOverride_Bloom2Size : 1; // 0x08(0x01)
	char bOverride_Bloom2Tint : 1; // 0x08(0x01)
	...
	char bOverride_Bloom6Tint : 1; // 0x09(0x01)
	char bOverride_Bloom6Size : 1; // 0x09(0x01)
	...
	char bOverride_BloomConvolutionPreFilterMax : 1; // 0x0a(0x01)
	char bOverride_BloomConvolutionPreFilterMult : 1; // 0x0a(0x01)
	...
	char bOverride_AutoExposureMethod : 1; // 0x0b(0x01)
	char bOverride_AutoExposureLowPercent : 1; // 0x0b(0x01)
	...
	char bOverride_AutoExposureBias : 1; // 0x0c(0x01)
	char bOverride_AutoExposureBiasCurve : 1; // 0x0c(0x01)
	...
	char bOverride_LensFlareTints : 1; // 0x0d(0x01)
	char bOverride_LensFlareBokehSize : 1; // 0x0d(0x01)
	...
	float PCBloomIntensity; // 0x90(0x04)
	float PCBloomThreshold; // 0x94(0x04)
	char pad_98[0x8]; // 0x98(0x08)
	struct FVector4 ColorSaturation; // 0xa0(0x10)
	struct FVector4 ColorContrast; // 0xb0(0x10)
	struct FVector4 ColorGamma; // 0xc0(0x10)
	struct FVector4 ColorGain; // 0xd0(0x10)
	struct FVector4 ColorOffset; // 0xe0(0x10)
	char pad_F0[0x10]; // 0xf0(0x10)
	struct FVector4 ColorSaturationShadows; // 0x100(0x10)
	struct FVector4 ColorContrastShadows; // 0x110(0x10)
	struct FVector4 ColorGammaShadows; // 0x120(0x10)
	struct FVector4 ColorGainShadows; // 0x130(0x10)
	struct FVector4 ColorOffsetShadows; // 0x140(0x10)
	struct FVector4 ColorSaturationMidtones; // 0x150(0x10)
	struct FVector4 ColorContrastMidtones; // 0x160(0x10)
	struct FVector4 ColorGammaMidtones; // 0x170(0x10)
	struct FVector4 ColorGainMidtones; // 0x180(0x10)
	struct FVector4 ColorOffsetMidtones; // 0x190(0x10)
	struct FVector4 ColorSaturationHighlights; // 0x1a0(0x10)
	struct FVector4 ColorContrastHighlights; // 0x1b0(0x10)
	struct FVector4 ColorGammaHighlights; // 0x1c0(0x10)
	struct FVector4 ColorGainHighlights; // 0x1d0(0x10)
	struct FVector4 ColorOffsetHighlights; // 0x1e0(0x10)
	float ColorCorrectionHighlightsMin; // 0x1f0(0x04)
	float ColorCorrectionShadowsMax; // 0x1f4(0x04)
	float BlueCorrection; // 0x1f8(0x04)
	float ExpandGamut; // 0x1fc(0x04)
	float FilmSlope; // 0x200(0x04)
	float FilmToe; // 0x204(0x04)
	float FilmShoulder; // 0x208(0x04)
	float FilmBlackClip; // 0x20c(0x04)
	float FilmWhiteClip; // 0x210(0x04)
	struct FLinearColor FilmWhitePoint; // 0x214(0x10)
	struct FLinearColor FilmShadowTint; // 0x224(0x10)
	float FilmShadowTintBlend; // 0x234(0x04)
	float FilmShadowTintAmount; // 0x238(0x04)
	float FilmSaturation; // 0x23c(0x04)
	struct FLinearColor FilmChannelMixerRed; // 0x240(0x10)
	struct FLinearColor FilmChannelMixerGreen; // 0x250(0x10)
	struct FLinearColor FilmChannelMixerBlue; // 0x260(0x10)
	float FilmContrast; // 0x270(0x04)
	float FilmToeAmount; // 0x274(0x04)
	float FilmHealAmount; // 0x278(0x04)
	float FilmDynamicRange; // 0x27c(0x04)
	struct FLinearColor SceneColorTint; // 0x280(0x10)
	float SceneFringeIntensity; // 0x290(0x04)
	float ChromaticAberrationStartOffset; // 0x294(0x04)
	float BloomIntensity; // 0x298(0x04)
	float BloomThreshold; // 0x29c(0x04)
	float BloomSizeScale; // 0x2a0(0x04)
	float Bloom1Size; // 0x2a4(0x04)
	float Bloom2Size; // 0x2a8(0x04)
	float Bloom3Size; // 0x2ac(0x04)
	float Bloom4Size; // 0x2b0(0x04)
	float Bloom5Size; // 0x2b4(0x04)
	float Bloom6Size; // 0x2b8(0x04)
	struct FLinearColor Bloom1Tint; // 0x2bc(0x10)
	struct FLinearColor Bloom2Tint; // 0x2cc(0x10)
	struct FLinearColor Bloom3Tint; // 0x2dc(0x10)
	struct FLinearColor Bloom4Tint; // 0x2ec(0x10)
	struct FLinearColor Bloom5Tint; // 0x2fc(0x10)
	struct FLinearColor Bloom6Tint; // 0x30c(0x10)
	float BloomConvolutionSize; // 0x31c(0x04)
	struct UTexture2D* BloomConvolutionTexture; // 0x320(0x08)
	struct FVector2D BloomConvolutionCenterUV; // 0x328(0x08)
	float BloomConvolutionPreFilterMin; // 0x330(0x04)
	float BloomConvolutionPreFilterMax; // 0x334(0x04)
	float BloomConvolutionPreFilterMult; // 0x338(0x04)
	float BloomConvolutionBufferScale; // 0x33c(0x04)
	struct UTexture* BloomDirtMask; // 0x340(0x08)
	float BloomDirtMaskIntensity; // 0x348(0x04)
	struct FLinearColor BloomDirtMaskTint; // 0x34c(0x10)
	struct FLinearColor AmbientCubemapTint; // 0x35c(0x10)
	float AmbientCubemapIntensity; // 0x36c(0x04)
	struct UTextureCube* AmbientCubemap; // 0x370(0x08)
	float CameraShutterSpeed; // 0x378(0x04)
	float CameraISO; // 0x37c(0x04)
	float DepthOfFieldFstop; // 0x380(0x04)
	float DepthOfFieldMinFstop; // 0x384(0x04)
	int32_t DepthOfFieldBladeCount; // 0x388(0x04)
	float AutoExposureBias; // 0x38c(0x04)
	float AutoExposureBiasBackup; // 0x390(0x04)
	char bOverride_AutoExposureBiasBackup : 1; // 0x394(0x01)
	char pad_394_1 : 7; // 0x394(0x01)
	char pad_395[0x3]; // 0x395(0x03)
	char AutoExposureApplyPhysicalCameraExposure : 1; // 0x398(0x01)
	char pad_398_1 : 7; // 0x398(0x01)
	char pad_399[0x7]; // 0x399(0x07)
	struct UCurveFloat* AutoExposureBiasCurve; // 0x3a0(0x08)
	struct UTexture* AutoExposureMeterMask; // 0x3a8(0x08)
	float AutoExposureLowPercent; // 0x3b0(0x04)
	float AutoExposureHighPercent; // 0x3b4(0x04)
	float AutoExposureMinBrightness; // 0x3b8(0x04)
	float AutoExposureMaxBrightness; // 0x3bc(0x04)
	float AutoExposureSpeedUp; // 0x3c0(0x04)
	float AutoExposureSpeedDown; // 0x3c4(0x04)
	float HistogramLogMin; // 0x3c8(0x04)
	float HistogramLogMax; // 0x3cc(0x04)
	float AutoExposureCalibrationConstant; // 0x3d0(0x04)
	float LensFlareIntensity; // 0x3d4(0x04)
	struct FLinearColor LensFlareTint; // 0x3d8(0x10)
	float LensFlareBokehSize; // 0x3e8(0x04)
	float LensFlareThreshold; // 0x3ec(0x04)
	struct UTexture* LensFlareBokehShape; // 0x3f0(0x08)
	struct FLinearColor LensFlareTints[0x8]; // 0x3f8(0x80)
	float VignetteIntensity; // 0x478(0x04)
	float GrainJitter; // 0x47c(0x04)
	float GrainIntensity; // 0x480(0x04)
	float AmbientOcclusionIntensity; // 0x484(0x04)
	float AmbientOcclusionStaticFraction; // 0x488(0x04)
	float AmbientOcclusionRadius; // 0x48c(0x04)
	char AmbientOcclusionRadiusInWS : 1; // 0x490(0x01)
	char pad_490_1 : 7; // 0x490(0x01)
	char pad_491[0x3]; // 0x491(0x03)
	float AmbientOcclusionFadeDistance; // 0x494(0x04)
	float AmbientOcclusionFadeRadius; // 0x498(0x04)
	float AmbientOcclusionDistance; // 0x49c(0x04)
	float AmbientOcclusionPower; // 0x4a0(0x04)
	float AmbientOcclusionBias; // 0x4a4(0x04)
	float AmbientOcclusionQuality; // 0x4a8(0x04)
	float AmbientOcclusionMipBlend; // 0x4ac(0x04)
	float AmbientOcclusionMipScale; // 0x4b0(0x04)
	float AmbientOcclusionMipThreshold; // 0x4b4(0x04)
	char RayTracingAO : 1; // 0x4b8(0x01)
	char pad_4B8_1 : 7; // 0x4b8(0x01)
	char pad_4B9[0x3]; // 0x4b9(0x03)
	int32_t RayTracingAOSamplesPerPixel; // 0x4bc(0x04)
	struct FLinearColor IndirectLightingColor; // 0x4c0(0x10)
	float IndirectLightingIntensity; // 0x4d0(0x04)
	enum class ERayTracingGlobalIlluminationType RayTracingGIType; // 0x4d4(0x01)
	char pad_4D5[0x3]; // 0x4d5(0x03)
	int32_t RayTracingGIMaxBounces; // 0x4d8(0x04)
	int32_t RayTracingGISamplesPerPixel; // 0x4dc(0x04)
	float ColorGradingIntensity; // 0x4e0(0x04)
	char pad_4E4[0x4]; // 0x4e4(0x04)
	struct UTexture* ColorGradingLUT; // 0x4e8(0x08)
	float DepthOfFieldSensorWidth; // 0x4f0(0x04)
	float DepthOfFieldFocalDistance; // 0x4f4(0x04)
	float DepthOfFieldDepthBlurAmount; // 0x4f8(0x04)
	float DepthOfFieldDepthBlurRadius; // 0x4fc(0x04)
	float DepthOfFieldFocalRegion; // 0x500(0x04)
	float DepthOfFieldNearTransitionRegion; // 0x504(0x04)
	float DepthOfFieldFarTransitionRegion; // 0x508(0x04)
	float DepthOfFieldScale; // 0x50c(0x04)
	float DepthOfFieldNearBlurSize; // 0x510(0x04)
	float DepthOfFieldFarBlurSize; // 0x514(0x04)
	float DepthOfFieldOcclusion; // 0x518(0x04)
	float DepthOfFieldSkyFocusDistance; // 0x51c(0x04)
	float DepthOfFieldVignetteSize; // 0x520(0x04)
	float MotionBlurAmount; // 0x524(0x04)
	float MotionBlurMax; // 0x528(0x04)
	int32_t MotionBlurTargetFPS; // 0x52c(0x04)
	float MotionBlurPerObjectSize; // 0x530(0x04)
	float LPVIntensity; // 0x534(0x04)
	float LPVVplInjectionBias; // 0x538(0x04)
	float LPVSize; // 0x53c(0x04)
	float LPVSecondaryOcclusionIntensity; // 0x540(0x04)
	float LPVSecondaryBounceIntensity; // 0x544(0x04)
	float LPVGeometryVolumeBias; // 0x548(0x04)
	float LPVEmissiveInjectionIntensity; // 0x54c(0x04)
	float LPVDirectionalOcclusionIntensity; // 0x550(0x04)
	float LPVDirectionalOcclusionRadius; // 0x554(0x04)
	float LPVDiffuseOcclusionExponent; // 0x558(0x04)
	float LPVSpecularOcclusionExponent; // 0x55c(0x04)
	float LPVDiffuseOcclusionIntensity; // 0x560(0x04)
	float LPVSpecularOcclusionIntensity; // 0x564(0x04)
	enum class EReflectionsType ReflectionsType; // 0x568(0x01)
...
struct FColorGradingSettings {
	struct FColorGradePerRangeSettings Global; // 0x00(0x60)
	...
	float ShadowsMax; // 0x180(0x04)
	float HighlightsMin; // 0x184(0x04)
