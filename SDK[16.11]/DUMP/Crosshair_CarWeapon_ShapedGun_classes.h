...
struct UCrosshair_CarWeapon_ShapedGun_C : UVehicleWeaponCrossHairWidget {
	...
	void SetPrograssPrecent(float Percent, int32_t Index, struct UProgressBar* InProgressBar); // Function Crosshair_CarWeapon_ShapedGun.Crosshair_CarWeapon_ShapedGun_C.SetPrograssPrecent // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x2d656b0
	struct UUserWidget* GetChargeWidget(); // Function Crosshair_CarWeapon_ShapedGun.Crosshair_CarWeapon_ShapedGun_C.GetChargeWidget // (Event|Protected|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x2d656b0
	...
	void OnUpdateChargeProgress(bool InbCharging, int32_t InChargeMode, float InChargeProgress, int32_t InChargeBurstCount); // Function Crosshair_CarWeapon_ShapedGun.Crosshair_CarWeapon_ShapedGun_C.OnUpdateChargeProgress // (Event|Protected|BlueprintEvent) // @ game+0x2d656b0
	void ExecuteUbergraph_Crosshair_CarWeapon_ShapedGun(int32_t EntryPoint); // Function Crosshair_CarWeapon_ShapedGun.Crosshair_CarWeapon_ShapedGun_C.ExecuteUbergraph_Crosshair_CarWeapon_ShapedGun // (Final|UbergraphFunction) // @ game+0x2d656b0
};
