...
struct UControlRigComponent : UActorComponent {
	...
	void OnPreInitialize(); // Function ControlRig.ControlRigComponent.OnPreInitialize // (Native|Event|Public|BlueprintEvent) // @ game+0x7e4180
	void OnPreEvaluate(); // Function ControlRig.ControlRigComponent.OnPreEvaluate // (Native|Event|Public|BlueprintEvent) // @ game+0xc6d000
	void OnPostInitialize(); // Function ControlRig.ControlRigComponent.OnPostInitialize // (Native|Event|Public|BlueprintEvent) // @ game+0xc6cfe0
	void OnPostEvaluate(); // Function ControlRig.ControlRigComponent.OnPostEvaluate // (Native|Event|Public|BlueprintEvent) // @ game+0xc6cfc0
	struct UControlRig* BP_GetControlRig(); // Function ControlRig.ControlRigComponent.BP_GetControlRig // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0xc6cf90
};
